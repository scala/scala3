...
class TrieMapTest {
  ...
  def nullValues_t10765(): Unit = {
    val trieMap = TrieMap[String, String | Null]("a" -> null)
  ...
  def nullValuesUpdate(): Unit = {
    def newTrieMap = TrieMap[String | Null, String | Null]("a" -> null, (null,  "b"), "c" -> "c")

    def check(tm: TrieMap[String | Null, String | Null], key: String | Null, beforeValue: Option[String | Null], afterValue: String | Null, resultingSet: Set[(String | Null, String | Null)]): Unit = {
      beforeValue match {
        case Some(b) =>
  ...
  def nullValuesReplaceKeyOldValueNewValue() = {
    ...
    def check(
      tm: TrieMap[String | Null, String | Null],
      key: String | Null,
      beforeValue: Option[String | Null],
      conditionalOldValue: String | Null,
      afterValue: String | Null,
      resultingSet: Set[(String | Null, String | Null)]): Unit = {
