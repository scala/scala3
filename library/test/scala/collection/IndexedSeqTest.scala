...
abstract class IndexedTest[T, E] {
  ...
  /** is a take / slice that results in all the data returned.
...
package IndexedTestImpl {
  ...
  trait UnitTestData extends DataProvider [BoxedUnit] {
    def toType(n: Int) = BoxedUnit.UNIT
  }

  abstract class ArrayTest[E] (
                               //the object or primitive type of the array
                               val TYPE: Class[?]) extends IndexedTest[Array[E], E]{
  ...
  abstract class ArraySeqTest[E](
                                      //the object or primitive type of the array
                                      val TYPE: Class[?]) extends IndexedTest[mutable.ArraySeq[E], E]  with DataProvider[E]{
  ...
  class UnitArrayTest extends ArrayTest[BoxedUnit](classOf[Unit]) with UnitTestData {
  ...
  class UnitArraySeqTest extends ArraySeqTest[BoxedUnit](classOf[Unit]) with UnitTestData {
    import mutable.ArraySeq
