...
class JTestList(vs: Int*) extends AbstractList[Int] {
  ...
  override def get(i: Int): Int = vs(i)
}
...
class EqualsTest {
  ...
  def jListOf(vs: Int*): JList[Int] = new JTestList(vs*)
  def jSetOf(vs: Int*): JSet[Int] = new JTestSet(vs*)
  def jMapOf(vs: (Int, String)*): JMap[Int, String] = new JTestMap(vs*)
