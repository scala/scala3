...
class SortedSetTest extends AllocationTest{
  ...
  @Test def empty(): Unit ={
    ...
    exactAllocates(24)(SortedSet.empty(using ord))
  }
  @Ignore("Probably needs the optimizer?")
  @Test def apply0(): Unit ={
    val ord = Ordering[String]
    exactAllocates(24)(SortedSet()(using ord))
  }
  @Test def apply1(): Unit ={
    val ord = Ordering[String]
    exactAllocates(152)(SortedSet("a")(using ord))
  }
  @Test def apply2(): Unit ={
    val ord = Ordering[String]
    exactAllocates(216)(SortedSet("a", "b")(using ord))
  }
