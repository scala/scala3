...
class IndexedSeqTest extends AllocationTest {
  ...
  @Test def testEqualsSimple(): Unit = {
    ...
    assertTrue(ArraySeq.empty[Int] == ArraySeq.empty[Int])
  ...
  @Test def testNotEqualsSimple2(): Unit = {
    assertTrue(ArraySeq.empty[Int] != ArraySeq(1, 2, 3))
  ...
  @Test def testNotEqualsSimple3(): Unit = {
    assertTrue(ArraySeq.empty[Int] != Vector(1, 2, 3))
  ...
  @Test def testEqualsSimpleNonAllocatingEmpty(): Unit = {
    ...
    nonAllocatingEqual(true, ArraySeq.empty[Int], ArraySeq.empty[Int])
    nonAllocatingEqual(true, Vector.empty, ArraySeq.empty[Int])
  }
