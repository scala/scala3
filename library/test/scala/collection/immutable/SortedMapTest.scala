...
class SortedMapTest extends AllocationTest {
  ...
  def testTransformReturnsSortedMap(): Unit = {
    ...
    assert((tm: SortedMap[Int, Int]).isInstanceOf[SortedMap[?, ?]])
  }
  ...
  @Test def empty(): Unit = {
    ...
    exactAllocates(24)(SortedMap.empty[String, String](using ord))
  }
  @Ignore("Probably needs the optimizer?")
  @Test def apply0(): Unit = {
    exactAllocates(24)(SortedMap[String, String]())
  }
  @Test def apply1(): Unit = {
    onlyAllocates(200)(SortedMap(("a", "a")))
  }
  @Test def apply2(): Unit = {
    onlyAllocates(312)(SortedMap(("a", "a"), ("b", "b")))
  }
}
