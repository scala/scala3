...
class SortedSetMapEqualsTest {
  ...
  def noOptimizedSetEqualityWhenOrderingsDiffer(): Unit = {
    checkSet(ord => mutable.SortedSet.newBuilder[Int](using ord))
    checkSet(ord => immutable.SortedSet.newBuilder[Int](using ord))
    checkMap(ord => mutable.SortedMap.newBuilder[Int, Any](using ord))
    checkMap(ord => immutable.SortedMap.newBuilder[Int, Any](using ord))
  }
  ...
  def compareSortedMapKeysByOrdering(): Unit = {
    ...
    val itm1 = scala.collection.immutable.TreeMap("A" -> "2")(using ord)
    val itm2 = scala.collection.immutable.TreeMap("a" -> "2")(using ord)
    val mtm1 = scala.collection.mutable.TreeMap("A" -> "2")(using ord)
    val mtm2 = scala.collection.mutable.TreeMap("a" -> "2")(using ord)
  ...
  def compareSortedSetsByOrdering(): Unit = {
    ...
    val its1 = scala.collection.immutable.TreeSet("A")(using ord)
    val its2 = scala.collection.immutable.TreeSet("a")(using ord)
    val mts1 = scala.collection.mutable.TreeSet("A")(using ord)
    val mts2 = scala.collection.mutable.TreeSet("a")(using ord)
