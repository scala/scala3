...
object Unliftable {
  ...
  given Option_delegate[T](using Staged[T], Unliftable[T]) as Unliftable[Option[T]] = new {
  ...
  given Tuple1_delegate[T1](using Staged[T1], Unliftable[T1]) as Unliftable[Tuple1[T1]] = new {
  ...
  given Tuple2_delegate[T1, T2](using Staged[T1], Staged[T2], Unliftable[T1], Unliftable[T2]) as Unliftable[Tuple2[T1, T2]] = new {
  ...
  given Tuple3_delegate[T1, T2, T3](using Staged[T1], Staged[T2], Staged[T3], Unliftable[T1], Unliftable[T2], Unliftable[T3]) as Unliftable[Tuple3[T1, T2, T3]] = new {
  ...
  given Tuple4_delegate[T1, T2, T3, T4](using Staged[T1], Staged[T2], Staged[T3], Staged[T4], Unliftable[T1], Unliftable[T2], Unliftable[T3], Unliftable[T4]) as Unliftable[Tuple4[T1, T2, T3, T4]] = new {
  ...
  given Tuple5_delegate[T1, T2, T3, T4, T5](using Staged[T1], Staged[T2], Staged[T3], Staged[T4], Staged[T5], Unliftable[T1], Unliftable[T2], Unliftable[T3], Unliftable[T4], Unliftable[T5]) as Unliftable[Tuple5[T1, T2, T3, T4, T5]] = new {
  ...
  given Tuple6_delegate[T1, T2, T3, T4, T5, T6](using Staged[T1], Staged[T2], Staged[T3], Staged[T4], Staged[T5], Staged[T6], Unliftable[T1], Unliftable[T2], Unliftable[T3], Unliftable[T4], Unliftable[T5], Unliftable[T6]) as Unliftable[Tuple6[T1, T2, T3, T4, T5, T6]] = new {
  ...
  given Tuple7_delegate[T1, T2, T3, T4, T5, T6, T7](using Staged[T1], Staged[T2], Staged[T3], Staged[T4], Staged[T5], Staged[T6], Staged[T7], Unliftable[T1], Unliftable[T2], Unliftable[T3], Unliftable[T4], Unliftable[T5], Unliftable[T6], Unliftable[T7]) as Unliftable[Tuple7[T1, T2, T3, T4, T5, T6, T7]] = new {
  ...
  given Tuple8_delegate[T1, T2, T3, T4, T5, T6, T7, T8](using Staged[T1], Staged[T2], Staged[T3], Staged[T4], Staged[T5], Staged[T6], Staged[T7], Staged[T8], Unliftable[T1], Unliftable[T2], Unliftable[T3], Unliftable[T4], Unliftable[T5], Unliftable[T6], Unliftable[T7], Unliftable[T8]) as Unliftable[Tuple8[T1, T2, T3, T4, T5, T6, T7, T8]] = new {
  ...
  given Seq_delegate[T](using Staged[T], Unliftable[T]) as Unliftable[Seq[T]] = new {
