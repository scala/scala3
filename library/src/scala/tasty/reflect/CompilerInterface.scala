...
trait CompilerInterface {
  ...
  def PackageClause_TypeTest(using ctx: Context): TypeTest[PackageClause]
  ...
  def Statement_TypeTest(using ctx: Context): TypeTest[Statement]

  /** Tree representing an import in the source code */
  type Import <: Statement

  def Import_TypeTest(using ctx: Context): TypeTest[Import]
  ...
  def Definition_TypeTest(using ctx: Context): TypeTest[Definition]
  ...
  def PackageDef_TypeTest(using ctx: Context): TypeTest[PackageDef]
  ...
  def ClassDef_TypeTest(using ctx: Context): TypeTest[ClassDef]
  ...
  def TypeDef_TypeTest(using ctx: Context): TypeTest[TypeDef]
  ...
  def DefDef_TypeTest(using ctx: Context): TypeTest[DefDef]
  ...
  def ValDef_TypeTest(using ctx: Context): TypeTest[ValDef]
  ...
  def Term_TypeTest(using ctx: Context): TypeTest[Term]
  ...
  def Ref_TypeTest(using ctx: Context): TypeTest[Ref]
  ...
  def Ident_TypeTest(using ctx: Context): TypeTest[Ident]
  ...
  def Select_TypeTest(using ctx: Context): TypeTest[Select]
  ...
  def Literal_TypeTest(using ctx: Context): TypeTest[Literal]
  ...
  def This_TypeTest(using ctx: Context): TypeTest[This]
  ...
  def New_TypeTest(using ctx: Context): TypeTest[New]
  ...
  def NamedArg_TypeTest(using ctx: Context): TypeTest[NamedArg]
  ...
  def Apply_TypeTest(using ctx: Context): TypeTest[Apply]
  ...
  def TypeApply_TypeTest(using ctx: Context): TypeTest[TypeApply]
  ...
  def Super_TypeTest(using ctx: Context): TypeTest[Super]
  ...
  def Typed_TypeTest(using ctx: Context): TypeTest[Typed]
  ...
  def Assign_TypeTest(using ctx: Context): TypeTest[Assign]
  ...
  def Block_TypeTest(using ctx: Context): TypeTest[Block]
  ...
  def Closure_TypeTest(using ctx: Context): TypeTest[Closure]
  ...
  def If_TypeTest(using ctx: Context): TypeTest[If]
  ...
  def Match_TypeTest(using ctx: Context): TypeTest[Match]
  ...
  def GivenMatch_TypeTest(using ctx: Context): TypeTest[GivenMatch]
  ...
  def Try_TypeTest(using ctx: Context): TypeTest[Try]
  ...
  def Return_TypeTest(using ctx: Context): TypeTest[Return]
  ...
  def Repeated_TypeTest(using ctx: Context): TypeTest[Repeated]
  ...
  def Inlined_TypeTest(using ctx: Context): TypeTest[Inlined]
  ...
  def SelectOuter_TypeTest(using ctx: Context): TypeTest[SelectOuter]
  ...
  def While_TypeTest(using ctx: Context): TypeTest[While]
  ...
  def TypeTree_TypeTest(using ctx: Context): TypeTest[TypeTree]
  ...
  def Inferred_TypeTest(using ctx: Context): TypeTest[Inferred]
  ...
  def TypeIdent_TypeTest(using ctx: Context): TypeTest[TypeIdent]
  ...
  def TypeSelect_TypeTest(using ctx: Context): TypeTest[TypeSelect]
  ...
  def Projection_TypeTest(using ctx: Context): TypeTest[Projection]
  ...
  def Singleton_TypeTest(using ctx: Context): TypeTest[Singleton]
  ...
  def Refined_TypeTest(using ctx: Context): TypeTest[Refined]
  ...
  def Applied_TypeTest(using ctx: Context): TypeTest[Applied]
  ...
  def Annotated_TypeTest(using ctx: Context): TypeTest[Annotated]
  ...
  def MatchTypeTree_TypeTest(using ctx: Context): TypeTest[MatchTypeTree]
  ...
  def ByName_TypeTest(using ctx: Context): TypeTest[ByName]
  ...
  def LambdaTypeTree_TypeTest(using ctx: Context): TypeTest[LambdaTypeTree]
  ...
  def TypeBind_TypeTest(using ctx: Context): TypeTest[TypeBind]
  ...
  def TypeBlock_TypeTest(using ctx: Context): TypeTest[TypeBlock]
  ...
  def TypeBoundsTree_TypeTest(using ctx: Context): TypeTest[TypeBoundsTree]
  ...
  def WildcardTypeTree_TypeTest(using ctx: Context): TypeTest[WildcardTypeTree]
  ...
  def CaseDef_TypeTest(using ctx: Context): TypeTest[CaseDef]
  ...
  def TypeCaseDef_TypeTest(using ctx: Context): TypeTest[TypeCaseDef]
  ...
  def Bind_TypeTest(using ctx: Context): TypeTest[Bind]
  ...
  def Unapply_TypeTest(using ctx: Context): TypeTest[Unapply]
  ...
  def Alternatives_TypeTest(using ctx: Context): TypeTest[Alternatives]
  ...
  def NoPrefix_TypeTest(using ctx: Context): TypeTest[NoPrefix]

  /** Type bounds */
  type TypeBounds <: TypeOrBounds

  def TypeBounds_TypeTest(using ctx: Context): TypeTest[TypeBounds]
  ...
  def Type_TypeTest(using ctx: Context): TypeTest[Type]
  ...
  def ConstantType_TypeTest(using ctx: Context): TypeTest[ConstantType]
  ...
  def TermRef_TypeTest(using ctx: Context): TypeTest[TermRef]
  ...
  def TypeRef_TypeTest(using ctx: Context): TypeTest[TypeRef]
  ...
  def SuperType_TypeTest(using ctx: Context): TypeTest[SuperType]
  ...
  def Refinement_TypeTest(using ctx: Context): TypeTest[Refinement]
  ...
  def AppliedType_TypeTest(using ctx: Context): TypeTest[AppliedType]
  ...
  def AnnotatedType_TypeTest(using ctx: Context): TypeTest[AnnotatedType]
  ...
  def AndType_TypeTest(using ctx: Context): TypeTest[AndType]
  ...
  def OrType_TypeTest(using ctx: Context): TypeTest[OrType]
  ...
  def MatchType_TypeTest(using ctx: Context): TypeTest[MatchType]
  ...
  def ByNameType_TypeTest(using ctx: Context): TypeTest[ByNameType]
  ...
  def ParamRef_TypeTest(using ctx: Context): TypeTest[ParamRef]
  ...
  def ThisType_TypeTest(using ctx: Context): TypeTest[ThisType]
  ...
  def RecursiveThis_TypeTest(using ctx: Context): TypeTest[RecursiveThis]
  ...
  def RecursiveType_TypeTest(using ctx: Context): TypeTest[RecursiveType]
  ...
  def MethodType_TypeTest(using ctx: Context): TypeTest[MethodType]
  ...
  def PolyType_TypeTest(using ctx: Context): TypeTest[PolyType]
  ...
  def TypeLambda_TypeTest(using ctx: Context): TypeTest[TypeLambda]
  ...
  def SimpleSelector_TypeTest(using ctx: Context): TypeTest[SimpleSelector]

  def SimpleSelector_selection(self: SimpleSelector)(using ctx: Context): Id

  type RenameSelector <: ImportSelector

  def RenameSelector_TypeTest(using ctx: Context): TypeTest[RenameSelector]
  ...
  def OmitSelector_TypeTest(using ctx: Context): TypeTest[OmitSelector]
  ...
  def ImplicitSearchSuccess_TypeTest(using ctx: Context): TypeTest[ImplicitSearchSuccess]
  ...
  def ImplicitSearchFailure_TypeTest(using ctx: Context): TypeTest[ImplicitSearchFailure]
  ...
  def DivergingImplicit_TypeTest(using ctx: Context): TypeTest[DivergingImplicit]

  type NoMatchingImplicits <: ImplicitSearchFailure
  def NoMatchingImplicits_TypeTest(using ctx: Context): TypeTest[NoMatchingImplicits]

  type AmbiguousImplicits <: ImplicitSearchFailure
  def AmbiguousImplicits_TypeTest(using ctx: Context): TypeTest[AmbiguousImplicits]
