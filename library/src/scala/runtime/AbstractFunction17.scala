...
/** A base class for seventeen-parameter function implementations, allowing a function
 *  value to be defined by extending a class rather than the [[scala.Function17]]
 *  trait.
 *
