...
final abstract class Long private extends AnyVal {
  ...
  def toByte: Byte
  /** Returns this value as a [[scala.Short]], which may involve truncation of the high-order bits. */
  def toShort: Short
  /** Returns this value as a [[scala.Char]], which may involve truncation of the high-order bits. */
  def toChar: Char
  /** Returns this value as an [[scala.Int]], which may involve truncation of the high-order bits. */
  def toInt: Int
