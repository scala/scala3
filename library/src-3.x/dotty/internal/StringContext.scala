...
object StringContext {
  ...
  /** Lifts a StringContext from StringContext to Expr of StringContext
    *
    * @return a Liftable StringContext by redefining the toExpr function
    */
  private implicit def StringContextIsLiftable: Liftable[StringContext] = new Liftable[StringContext] {
