 ...
 */
object Dependencies {
  private val jacksonVersion = "2.15.1" // copied in build.mill
  ...
  private val flexmarkVersion = "0.62.2" // copied in build.mill
  ...
  val compilerInterface = "org.scala-sbt" % "compiler-interface" % "1.10.7" // copied in build.mill
}
