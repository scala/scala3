...
object CompilerCommand {
  ...
  def distill(args: Array[String])(implicit ctx: ContextRenamed): ArgsSummary = {
    /**
   ...
   */
  def checkUsage(summary: ArgsSummary, sourcesRequired: Boolean)(implicit ctx: ContextRenamed): List[String] = {
