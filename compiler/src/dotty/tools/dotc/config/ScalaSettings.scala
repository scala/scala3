...
class ScalaSettings extends Settings.SettingGroup {
  ...
  val optimise = BooleanSetting("-optimise", "Generates faster bytecode by applying local optimisations to the .program", initialValue = true) withAbbreviation "-optimize"
