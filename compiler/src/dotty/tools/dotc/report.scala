...
object report:
  ...
  def inform(msg: => String, pos: SourcePosition = NoSourcePosition)(using Context): Unit =
    if ctx.settings.verbose.value then echo(msg, pos)

  def echo(msg: => String, pos: SourcePosition = NoSourcePosition)(using Context): Unit =
    ctx.reporter.report(new Info(msg, pos))
  ...
  def deprecationWarning(msg: Message, pos: SourcePosition = NoSourcePosition)(using Context): Unit =
    issueWarning(new DeprecationWarning(msg, pos))

  def migrationWarning(msg: Message, pos: SourcePosition = NoSourcePosition)(using Context): Unit =
    issueWarning(new MigrationWarning(msg, pos))

  def uncheckedWarning(msg: Message, pos: SourcePosition = NoSourcePosition)(using Context): Unit =
    issueWarning(new UncheckedWarning(msg, pos))

  def featureWarning(msg: Message, pos: SourcePosition = NoSourcePosition)(using Context): Unit =
    issueWarning(new FeatureWarning(msg, pos))

  def featureWarning(feature: String, featureDescription: String,
      featureUseSite: Symbol, required: Boolean, pos: SourcePosition)(using Context): Unit = {
    ...
    else issueWarning(new FeatureWarning(msg, pos))
  }

  def warning(msg: Message, pos: SourcePosition = NoSourcePosition)(using Context): Unit =
    issueWarning(new Warning(msg, addInlineds(pos)))

  def error(msg: Message, pos: SourcePosition = NoSourcePosition, sticky: Boolean = false)(using Context): Unit =
  ...
  def error(ex: TypeError, pos: SourcePosition)(using Context): Unit =
  ...
  def restrictionError(msg: Message, pos: SourcePosition = NoSourcePosition)(using Context): Unit =
  ...
  def incompleteInputError(msg: Message, pos: SourcePosition = NoSourcePosition)(using Context): Unit =
    ctx.reporter.incomplete(new Error(msg, pos))
  ...
  def debugwarn(msg: => String, pos: SourcePosition = NoSourcePosition)(using Context): Unit =
