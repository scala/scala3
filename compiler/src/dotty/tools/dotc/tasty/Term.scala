...
object Term {
  ...
  def apply(tree: Tree)(implicit ctx: Context): scala.tasty.Term = Impl(tree, ctx)
...
//  case SelectOuter(from: Term, levels: Int, target: Type) // can be generated by inlining
  ...
  private case class Impl(tree: Tree, ctx: Context) extends scala.tasty.Term with Positioned {
