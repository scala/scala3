...
// ----- Term names -----------------------------------------
    ...
    val reify : N               = "reify"
    val replace : N             = "replace"
    val replaceFirst : N        = "replaceFirst"
    val replaceAll : N          = "replaceAll"
