...
class Definitions {
  ...
  lazy val ScalaPackageObjectRef: Types.TermRef = ctx.requiredModuleRef("scala.package")
  ...
  lazy val SysPackage: TermSymbol = ctx.requiredModule("scala.sys.package")
    lazy val Sys_errorR: Types.TermRef = SysPackage.moduleClass.requiredMethodRef(nme.error)
    def Sys_error(implicit ctx: Context): Symbol = Sys_errorR.symbol

  lazy val TypelevelPackageObjectRef: Types.TermRef = ctx.requiredModuleRef("scala.typelevel.package")
  lazy val TypelevelPackageObject: Symbol = TypelevelPackageObjectRef.symbol.moduleClass
    lazy val Typelevel_errorR: Types.TermRef = TypelevelPackageObjectRef.symbol.requiredMethodRef(nme.error)
    def Typelevel_error(implicit ctx: Context): Symbol = Typelevel_errorR.symbol
    lazy val Typelevel_constValueR: Types.TermRef = TypelevelPackageObjectRef.symbol.requiredMethodRef("constValue")
    def Typelevel_constValue(implicit ctx: Context): Symbol = Typelevel_constValueR.symbol
    lazy val Typelevel_constValueOptR: Types.TermRef = TypelevelPackageObjectRef.symbol.requiredMethodRef("constValueOpt")
  ...
  def AnyValType: TypeRef = AnyValClass.typeRef
    ...
    def AnyMethods: List[Symbols.TermSymbol] = List(Any_==, Any_!=, Any_equals, Any_hashCode,
  ...
  lazy val RuntimeNothingModuleRef: Types.TermRef = ctx.requiredModuleRef("scala.runtime.Nothing")
  ...
  lazy val ScalaPredefModuleRef: Types.TermRef = ctx.requiredModuleRef("scala.Predef")
  def ScalaPredefModule(implicit ctx: Context): Symbol = ScalaPredefModuleRef.symbol
    ...
    lazy val Predef_conformsR: Types.TermRef = ScalaPredefModule.requiredMethodRef(nme.conforms_)
    def Predef_conforms(implicit ctx: Context): Symbol = Predef_conformsR.symbol
    lazy val Predef_classOfR: Types.TermRef = ScalaPredefModule.requiredMethodRef(nme.classOf)
    def Predef_classOf(implicit ctx: Context): Symbol = Predef_classOfR.symbol
    lazy val Predef_undefinedR: Types.TermRef = ScalaPredefModule.requiredMethodRef(nme.???)
    def Predef_undefined(implicit ctx: Context): Symbol = Predef_undefinedR.symbol

  lazy val ScalaRuntimeModuleRef: Types.TermRef = ctx.requiredModuleRef("scala.runtime.ScalaRunTime")
  ...
  def ScalaRuntimeClass(implicit ctx: Context): ClassSymbol = ScalaRuntimeModule.moduleClass.asClass
    ...
    def runtimeMethodRef(name: PreName): Types.TermRef = ScalaRuntimeModule.requiredMethodRef(name)
    def ScalaRuntime_dropR(implicit ctx: Context): Types.TermRef = runtimeMethodRef(nme.drop)
    def ScalaRuntime_drop(implicit ctx: Context): Symbol = ScalaRuntime_dropR.symbol

  lazy val BoxesRunTimeModuleRef: Types.TermRef = ctx.requiredModuleRef("scala.runtime.BoxesRunTime")
  ...
  lazy val ScalaStaticsModuleRef: Types.TermRef = ctx.requiredModuleRef("scala.runtime.Statics")
  ...
  def ScalaStaticsClass(implicit ctx: Context): ClassSymbol = ScalaStaticsModule.moduleClass.asClass
    ...
    def staticsMethodRef(name: PreName): Types.TermRef = ScalaStaticsModule.requiredMethodRef(name)
  ...
  def DottyPredefModuleRef: Types.TermRef = {
  ...
  lazy val DottyArraysModuleRef: Types.TermRef = ctx.requiredModuleRef("dotty.runtime.Arrays")
  ...
  lazy val NilModuleRef: Types.TermRef = ctx.requiredModuleRef("scala.collection.immutable.Nil")
  ...
  def SeqClass(implicit ctx: Context): ClassSymbol = SeqType.symbol.asClass
    lazy val Seq_applyR: Types.TermRef = SeqClass.requiredMethodRef(nme.apply)
    def Seq_apply(implicit ctx: Context): Symbol = Seq_applyR.symbol
    lazy val Seq_headR: Types.TermRef = SeqClass.requiredMethodRef(nme.head)
    def Seq_head(implicit ctx: Context): Symbol = Seq_headR.symbol
    lazy val Seq_dropR: Types.TermRef = SeqClass.requiredMethodRef(nme.drop)
    def Seq_drop(implicit ctx: Context): Symbol = Seq_dropR.symbol
    lazy val Seq_lengthCompareR: Types.TermRef = SeqClass.requiredMethodRef(nme.lengthCompare)
    def Seq_lengthCompare(implicit ctx: Context): Symbol = Seq_lengthCompareR.symbol
    lazy val Seq_lengthR: Types.TermRef = SeqClass.requiredMethodRef(nme.length)
    def Seq_length(implicit ctx: Context): Symbol = Seq_lengthR.symbol
    lazy val Seq_toSeqR: Types.TermRef = SeqClass.requiredMethodRef(nme.toSeq)
  ...
  def ArrayClass(implicit ctx: Context): ClassSymbol = ArrayType.symbol.asClass
    lazy val Array_applyR: Types.TermRef                 = ArrayClass.requiredMethodRef(nme.apply)
    def Array_apply(implicit ctx: Context): Symbol = Array_applyR.symbol
    lazy val Array_updateR: Types.TermRef                = ArrayClass.requiredMethodRef(nme.update)
    def Array_update(implicit ctx: Context): Symbol = Array_updateR.symbol
    lazy val Array_lengthR: Types.TermRef                = ArrayClass.requiredMethodRef(nme.length)
    def Array_length(implicit ctx: Context): Symbol = Array_lengthR.symbol
    lazy val Array_cloneR: Types.TermRef                 = ArrayClass.requiredMethodRef(nme.clone_)
    def Array_clone(implicit ctx: Context): Symbol = Array_cloneR.symbol
    lazy val ArrayConstructorR: Types.TermRef            = ArrayClass.requiredMethodRef(nme.CONSTRUCTOR)
    def ArrayConstructor(implicit ctx: Context): Symbol = ArrayConstructorR.symbol
  lazy val ArrayModuleType: Types.TermRef = ctx.requiredModuleRef("scala.Array")
  ...
  def BooleanClass(implicit ctx: Context): ClassSymbol = BooleanType.symbol.asClass
    lazy val Boolean_notR: Types.TermRef   = BooleanClass.requiredMethodRef(nme.UNARY_!)
    def Boolean_! : Symbol = Boolean_notR.symbol
    lazy val Boolean_andR: Types.TermRef = BooleanClass.requiredMethodRef(nme.ZAND) // ### harmonize required... calls
    def Boolean_&& : Symbol = Boolean_andR.symbol
    lazy val Boolean_orR: Types.TermRef  = BooleanClass.requiredMethodRef(nme.ZOR)
  ...
  def IntClass(implicit ctx: Context): ClassSymbol = IntType.symbol.asClass
    lazy val Int_minusR: Types.TermRef   = IntClass.requiredMethodRef(nme.MINUS, List(IntType))
    def Int_- : Symbol = Int_minusR.symbol
    lazy val Int_plusR: Types.TermRef   = IntClass.requiredMethodRef(nme.PLUS, List(IntType))
    def Int_+ : Symbol = Int_plusR.symbol
    lazy val Int_divR: Types.TermRef   = IntClass.requiredMethodRef(nme.DIV, List(IntType))
    def Int_/ : Symbol = Int_divR.symbol
    lazy val Int_mulR: Types.TermRef   = IntClass.requiredMethodRef(nme.MUL, List(IntType))
    def Int_* : Symbol = Int_mulR.symbol
    lazy val Int_eqR: Types.TermRef   = IntClass.requiredMethodRef(nme.EQ, List(IntType))
    def Int_== : Symbol = Int_eqR.symbol
    lazy val Int_geR: Types.TermRef   = IntClass.requiredMethodRef(nme.GE, List(IntType))
    def Int_>= : Symbol = Int_geR.symbol
    lazy val Int_leR: Types.TermRef   = IntClass.requiredMethodRef(nme.LE, List(IntType))
  ...
  def LongClass(implicit ctx: Context): ClassSymbol = LongType.symbol.asClass
    ...
    lazy val Long_plusR: Types.TermRef   = LongClass.requiredMethodRef(nme.PLUS, List(LongType))
    def Long_+ : Symbol = Long_plusR.symbol
    lazy val Long_mulR: Types.TermRef   = LongClass.requiredMethodRef(nme.MUL, List(LongType))
    def Long_* : Symbol = Long_mulR.symbol
    lazy val Long_divR: Types.TermRef   = LongClass.requiredMethodRef(nme.DIV, List(LongType))
  ...
  def StringAddClass(implicit ctx: Context): ClassSymbol = StringAddType.symbol.asClass
    ...
    lazy val StringAdd_plusR: Types.TermRef = StringAddClass.requiredMethodRef(nme.raw.PLUS)
  ...
  def StringContextClass(implicit ctx: Context): ClassSymbol = StringContextType.symbol.asClass
    lazy val StringContextSR: Types.TermRef = StringContextClass.requiredMethodRef(nme.s)
    def StringContextS(implicit ctx: Context): Symbol = StringContextSR.symbol
    lazy val StringContextRawR: Types.TermRef = StringContextClass.requiredMethodRef(nme.raw_)
  ...
  def StringContextModule(implicit ctx: Context): Symbol = StringContextClass.companionModule
    lazy val StringContextModule_applyR: Types.TermRef = StringContextModule.requiredMethodRef(nme.apply)
  ...
  def PartialFunctionClass(implicit ctx: Context): ClassSymbol = PartialFunctionType.symbol.asClass
    lazy val PartialFunction_isDefinedAtR: Types.TermRef = PartialFunctionClass.requiredMethodRef(nme.isDefinedAt)
    def PartialFunction_isDefinedAt(implicit ctx: Context): Symbol = PartialFunction_isDefinedAtR.symbol
    lazy val PartialFunction_applyOrElseR: Types.TermRef = PartialFunctionClass.requiredMethodRef(nme.applyOrElse)
  ...
  def ScalaSymbolModule(implicit ctx: Context): Symbol         = ScalaSymbolClass.companionModule
    lazy val ScalaSymbolModule_applyR: Types.TermRef                  = ScalaSymbolModule.requiredMethodRef(nme.apply, List(StringType))
  ...
  def ProductClass(implicit ctx: Context): ClassSymbol = ProductType.symbol.asClass
    lazy val Product_canEqualR: Types.TermRef = ProductClass.requiredMethodRef(nme.canEqual_)
    def Product_canEqual(implicit ctx: Context): Symbol = Product_canEqualR.symbol
    lazy val Product_productArityR: Types.TermRef = ProductClass.requiredMethodRef(nme.productArity)
    def Product_productArity(implicit ctx: Context): Symbol = Product_productArityR.symbol
    lazy val Product_productElementR: Types.TermRef = ProductClass.requiredMethodRef(nme.productElement)
    def Product_productElement(implicit ctx: Context): Symbol = Product_productElementR.symbol
    lazy val Product_productPrefixR: Types.TermRef = ProductClass.requiredMethodRef(nme.productPrefix)
  ...
  def QuotedExprModule(implicit ctx: Context): Symbol = QuotedExprClass.companionModule
    lazy val QuotedExpr_applyR: Types.TermRef = QuotedExprModule.requiredMethodRef(nme.apply)
  ...
  lazy val QuotedTypeModuleType: Types.TermRef = ctx.requiredModuleRef("scala.quoted.Type")
  def QuotedTypeModule(implicit ctx: Context): Symbol = QuotedTypeModuleType.symbol
    lazy val QuotedType_applyR: Types.TermRef = QuotedTypeModule.requiredMethodRef(nme.apply)
  ...
  def QuotedLiftableModuleClass(implicit ctx: Context): ClassSymbol = QuotedLiftableModule.asClass
    ...
    def QuotedLiftable_BooleanIsLiftable: Types.TermRef = QuotedLiftableModule.requiredMethodRef("BooleanIsLiftable")
    def QuotedLiftable_ByteIsLiftable: Types.TermRef = QuotedLiftableModule.requiredMethodRef("ByteIsLiftable")
    def QuotedLiftable_CharIsLiftable: Types.TermRef = QuotedLiftableModule.requiredMethodRef("CharIsLiftable")
    def QuotedLiftable_ShortIsLiftable: Types.TermRef = QuotedLiftableModule.requiredMethodRef("ShortIsLiftable")
    def QuotedLiftable_IntIsLiftable: Types.TermRef = QuotedLiftableModule.requiredMethodRef("IntIsLiftable")
    def QuotedLiftable_LongIsLiftable: Types.TermRef = QuotedLiftableModule.requiredMethodRef("LongIsLiftable")
    def QuotedLiftable_FloatIsLiftable: Types.TermRef = QuotedLiftableModule.requiredMethodRef("FloatIsLiftable")
    def QuotedLiftable_DoubleIsLiftable: Types.TermRef = QuotedLiftableModule.requiredMethodRef("DoubleIsLiftable")
    def QuotedLiftable_StringIsLiftable: Types.TermRef = QuotedLiftableModule.requiredMethodRef("StringIsLiftable")
  ...
  lazy val XMLTopScopeModuleRef: Types.TermRef = ctx.requiredModuleRef("scala.xml.TopScope")
  ...
  def FunctionClass(n: Int, isImplicit: Boolean = false, isErased: Boolean = false)(implicit ctx: Context): Symbol =
    ...
    lazy val Function0_applyR: Types.TermRef = ImplementedFunctionType(0).symbol.requiredMethodRef(nme.apply)
  ...
  val StaticRootImportFns: List[() => Types.TermRef] = List[() => TermRef](
    () => JavaLangPackageVal.termRef,
    () => ScalaPackageVal.termRef
  )

  val PredefImportFns: List[() => Types.TermRef] = List[() => TermRef](
    () => ScalaPredefModuleRef,
    () => DottyPredefModuleRef
  )

  lazy val RootImportFns: List[() => Types.TermRef] =
  ...
  lazy val NotRuntimeClasses: Set[Symbol] = Set[Symbol](AnyClass, AnyValClass, NullClass, NothingClass)
  ...
  val ScalaNumericValueClasses: PerRun[collection.Set[Symbol]] = new PerRun[collection.Set[Symbol]](implicit ctx => ScalaNumericValueTypes.map(_.symbol))
  val ScalaValueClasses: PerRun[collection.Set[Symbol]]        = new PerRun[collection.Set[Symbol]](implicit ctx => ScalaValueTypes.map(_.symbol))
  val ScalaBoxedClasses: PerRun[collection.Set[Symbol]]        = new PerRun[collection.Set[Symbol]](implicit ctx => ScalaBoxedTypes.map(_.symbol))
...
//    valueTypeNamesToJavaType.get(if (name.firstPart eq nme.scala_) name.lastPart.toTypeName else name)
  ...
  lazy val erasedToObject: Set[Symbol] = Set[Symbol](AnyClass, AnyValClass, TupleClass, NonEmptyTupleClass, SingletonClass)
  ...
  lazy val syntheticCoreClasses: List[Symbols.Symbol { type ThisName >: TypeName with Names.TermName <: Name { type ThisName >: TypeName with Names.TermName <: Name } }] = syntheticScalaClasses ++ List(
    EmptyPackageVal,
    OpsPackageClass)

  /** Lists core methods that don't have underlying bytecode, but are synthesized on-the-fly in every reflection universe */
  lazy val syntheticCoreMethods: List[Symbols.TermSymbol] =
