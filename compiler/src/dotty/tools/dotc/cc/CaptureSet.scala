...
object CaptureSet:
   ...
   */
  final def extrapolateCaptureRef(r: CaptureRef, tm: TypeMap, variance: Int)(using Context): CaptureSet =
   ...
   */
  case class ExistentialSubsumesFailure(val ex: ResultCap, val other: CaptureRef) extends ErrorNote
