...
object messages {
  ...
  extends Message(PatternMatchExhaustivityID) {
    val kind = PATTERN_MATCH_EXHAUSTIVITY
    val msg =
  ...
  extends Message(MatchCaseUnreachableID) {
    val kind = MATCH_CASE_UNREACHABLE
    val msg = hl"Match ${hl"case"} Unreachable"
    val explanation = ""
  }
