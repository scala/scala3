...
import dotty.tools.dotc.core.Contexts.{Context, SourceInfo}
...
package object tastyreflect {
  ...
  case class PackageDefinitionImpl[-T >: Untyped] private[tastyreflect] (sym: Symbol)(implicit @transientParam src: SourceInfo) extends Tree[T] {
