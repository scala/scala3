...
object Profiler {
  def apply()(implicit ctx: ContextRenamed): Profiler =
...
private [profile] class RealProfiler(reporter : ProfileReporter)(implicit ctx: ContextRenamed) extends Profiler with NotificationListener {
