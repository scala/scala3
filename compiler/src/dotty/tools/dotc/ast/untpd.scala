...
object untpd extends Trees.Instance[Untyped] with UntypedTreeInfo {
   ...
   */
  class DerivingTemplate(constr: DefDef, parentsOrDerived: List[Tree], self: ValDef, preBody: LazyTreeLst, derivedCount: Int)(implicit @constructorOnly src: SourceFile)
  ...
  case class ExtMethods(tparams: Lst[TypeDef], vparamss: Lst[Lst[ValDef]], methods: List[DefDef])(implicit @constructorOnly src: SourceFile) extends Tree
  ...
  case class DependentTypeTree(tp: Lst[Symbol] => Type)(implicit @constructorOnly src: SourceFile) extends Tree
   ...
   *  `Positioned#checkPos` */
  class XMLBlock(stats: Lst[Tree], expr: Tree)(implicit @constructorOnly src: SourceFile) extends Block(stats, expr)
  ...
  def Try(expr: Tree, cases: Lst[CaseDef], finalizer: Tree)(implicit src: SourceFile): Try = new Try(expr, cases, finalizer)
  def SeqLiteral(elems: Lst[Tree], elemtpt: Tree)(implicit src: SourceFile): SeqLiteral = new SeqLiteral(elems, elemtpt)
  def JavaSeqLiteral(elems: Lst[Tree], elemtpt: Tree)(implicit src: SourceFile): JavaSeqLiteral = new JavaSeqLiteral(elems, elemtpt)
  def Inlined(call: tpd.Tree, bindings: Lst[MemberDef], expansion: Tree)(implicit src: SourceFile): Inlined = new Inlined(call, bindings, expansion)
  ...
  def DefDef(name: TermName, tparams: Lst[TypeDef], vparamss: Lst[Lst[ValDef]], tpt: Tree, rhs: LazyTree)(implicit src: SourceFile): DefDef = new DefDef(name, tparams, vparamss, tpt, rhs)
   ...
   *  PrepareInlineable.
   */
  def New(tpt: Tree, argss: Lst[Lst[Tree]])(using Context): Tree =
  ...
  def makeConstructor(tparams: Lst[TypeDef], vparamss: Lst[Lst[ValDef]], rhs: Tree = EmptyTree)(using Context): DefDef =
  ...
  def lambdaAbstract(params: Lst[ValDef] | Lst[TypeDef], tpt: Tree)(using Context): Tree =
    params match
      case NIL               => tpt
      case (vd: ValDef) +: _ => TermLambdaTypeTree(params.asInstanceOf[Lst[ValDef]], tpt)
      case _                 => LambdaTypeTree(params.asInstanceOf[Lst[TypeDef]], tpt)

  def lambdaAbstractAll(paramss: Lst[Lst[ValDef] | Lst[TypeDef]], tpt: Tree)(using Context): Tree =
...
// --------- Copier/Transformer/Accumulator classes for untyped trees -----
  ...
  class UntypedTreeCopier extends TreeCopier {
    ...
    def ExtMethods(tree: Tree)(tparams: Lst[TypeDef], vparamss: Lst[Lst[ValDef]], methods: List[DefDef])(using Context): Tree = tree match
