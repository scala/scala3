...
private[nio] final class MemoryFile(override val parent: MemoryContainer, override val nameWithoutExtension: String, override val extension: FileExtension) extends File:
