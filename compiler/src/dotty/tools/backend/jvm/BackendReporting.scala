...
object BackendReporting {
  ...
  final case class RewriteClosureAccessCheckFailed(pos: SrcPos, cause: OptimizerWarning) extends RewriteClosureApplyToClosureBodyFailed
  final case class RewriteClosureIllegalAccess(pos: SrcPos, callsiteClass: InternalName) extends RewriteClosureApplyToClosureBodyFailed
