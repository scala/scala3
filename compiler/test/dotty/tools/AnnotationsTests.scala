...
class AnnotationsTest:
  ...
  @Test def surviveMissingAnnot: Unit =
    withJavaCompiled(
      ...
      javaOutputDir.getFile("Annot1.class").get.delete()
      inCompilerContext(javaOutputDir.path + ClassPath.pathSeparator + TestConfiguration.basicClasspath) {
        val cls = requiredClass("A")
  ...
  @Test def surviveMissingInnerClassAnnot: Unit =
    withJavaCompiled(
      ...
      javaOutputDir.getContainer("a").get.getContainer("b").get.getFile("Outer.class").get.delete()
      javaOutputDir.getContainer("a").get.getContainer("b").get.getFile("Outer$Value.class").get.delete()
      javaOutputDir.getContainer("a").get.getContainer("b").get.getFile("Outer$Value$Immutable.class").get.delete()
      inCompilerContext(javaOutputDir.path + ClassPath.pathSeparator + TestConfiguration.basicClasspath) {
