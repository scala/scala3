...
class CompilationTests {
  ...
  @Test def pos: Unit = {
    ...
    aggregateTests(
      ...
      compileFilesInDir("tests/pos-special/captures", defaultOptions.and("-Yrefine-types")),
  ...
  @Test def negAll: Unit = {
    ...
    aggregateTests(
      ...
      compileFilesInDir("tests/neg-custom-args/captures", defaultOptions.and("-Yrefine-types")),
