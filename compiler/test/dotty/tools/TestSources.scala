...
object TestSources {
  ...
  def posFromTastyExcludelisted: Vector[String] = loadList(posFromTastyExcludelistFile)
  def posTestPicklingExcludelisted: Vector[String] = loadList(posTestPicklingExcludelistFile)
  def posTestRecheckExcluded: Vector[String] = loadList(posTestRecheckExcludesFile)
  def posLazyValsAllowlist: Vector[String] = loadList(posLazyValsAllowlistFile)
  def posLintingAllowlist: Vector[String] = loadList(posLintingAllowlistFile)
  def posInitGlobalScala2LibraryTastyExcludelisted: Vector[String] =
  ...
  def runFromTastyExcludelisted: Vector[String] = loadList(runFromTastyExcludelistFile)
  def runTestPicklingExcludelisted: Vector[String] = loadList(runTestPicklingExcludelistFile)
  def runTestRecheckExcluded: Vector[String] = loadList(runTestRecheckExcludesFile)
  def runLazyValsAllowlist: Vector[String] = loadList(runLazyValsAllowlistFile)
  def runMacrosScala2LibraryTastyExcludelisted: Vector[String] =
  ...
  def patmatExhaustivityScala2LibraryTastyExcludelisted: Vector[String] =
  ...
  def negBestEffortPicklingExcludelisted: Vector[String] = loadList(negBestEffortPicklingExcludelistFile)
  def negBestEffortUnpicklingExcludelisted: Vector[String] = loadList(negBestEffortUnpicklingExcludelistFile)

  // scoverage tests lists

  def scoverageIgnoreExcludelistFile: String = "compiler/test/dotc/scoverage-ignore.excludelist"

  def scoverageIgnoreExcludelisted: Vector[String] = loadList(scoverageIgnoreExcludelistFile)

  // load lists

  private def loadList(path: String): Vector[String] = {
  ...
  def sources(path: Path, excludedFiles: Vector[String] = Vector(), shallow: Boolean = false): Vector[String] = {
