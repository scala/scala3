...
For discussion, see [PR #10940](https://github.com/scala/scala3/pull/10940). For more information about the extension methods, see [documentation](https://nightly.scala-lang.org/docs/reference/contextual/extension-methods.html).
...
For the details and discussion, see [PR #11244](https://github.com/scala/scala3/pull/11244). Read more about this change in the [documentation](https://nightly.scala-lang.org/docs/reference/changed-features/imports.html).
...
For discussion, see [PR #11231](https://github.com/scala/scala3/pull/11231), and the [documentation](https://nightly.scala-lang.org/docs/reference/dropped-features/wildcard-init.html) is available on our website.
...
For details, see [PR #11349](https://github.com/scala/scala3/pull/11349). To read more about `scaladoc`, see [documentation](https://nightly.scala-lang.org/docs/usage/scaladoc/index.html)
