...
```scala sc:compile sc-opts:-experimental,-language:experimental.inlineTraits
...
```scala sc:fail sc-opts:-explain,-Werror,-experimental,-language:experimental.inlineTraits
