...
```scala sc:fail sc-opts:-experimental,-language:experimental.specializedTraits
...
```scala sc:fail sc-opts:-explain,-Werror,-experimental,-language:experimental.specializedTraits
...
```scala sc:nocompile custom-sc:compile sc-opts:-experimental,-language:experimental.specializedTraits
