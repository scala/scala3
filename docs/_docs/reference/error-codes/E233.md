---
title: E233: Illegal Use of Specialized Error
kind: Error
since: 3.10.0
---
...
```scala sc:fail sc-opts:-experimental,-language:experimental.inlineTraits
...
```scala sc:compile sc-opts:-experimental,sc-opts:-experimental,-language:experimental.inlineTraits
inline trait Vec[T: Specialized](val x: T)
