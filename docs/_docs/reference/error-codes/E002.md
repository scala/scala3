...
2 |  try println("hello")
  ...
  | }
  |
  | It is recommended to catch Exception rather than Throwable as the latter
  | includes Error instances which indicate grave issues that should not be ignored.
   -----------------------------------------------------------------------------
```
