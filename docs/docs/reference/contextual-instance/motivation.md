...
The following pages introduce a redesign of contextual abstractions in Scala. They introduce four fundamental changes:
 ...
 3. [Instance Imports](./import-implied.html) are new form of import that specifically imports implicit definitions and nothing else. New-style instance definitions _must be_ imported with  `import instance`, a plain import will no longer bring them into scope. Old-style implicit definitions can be imported with either form.
