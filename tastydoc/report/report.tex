...
%   General comparison
%   Extra features of Tastydoc
%   Error in Dottydoc that Tastydoc fixes
%
%   search engine, etc. Dottydoc has
%   Dottydoc not companion
%Remove part saying you cannot custom Dottydoc
...
% https://dotty.epfl.ch/api/scala/tasty/reflect/Kernel.html Artifcats
