...
/**  Messages
  ...
  */
  ...
  abstract class EmptyCatchOrFinallyBlock(tryBody: untpd.Tree, errNo: ErrorMessageID)(using Ctx, CState)
  ...
  class EmptyCatchBlock(tryBody: untpd.Tree)(using Ctx, CState)
  ...
  class EmptyCatchAndFinallyBlock(tryBody: untpd.Tree)(using Ctx, CState)
  ...
  class DeprecatedWithOperator()(using Ctx, CState)
  ...
  class CaseClassMissingParamList(cdef: untpd.TypeDef)(using Ctx, CState)
  ...
  class WildcardOnTypeArgumentNotAllowedOnNew()(using Ctx, CState)
  ...
  // Type Errors ------------------------------------------------------------ //
  class DuplicateBind(bind: untpd.Bind, tree: untpd.CaseDef)(using Ctx, CState)
  ...
  class MissingIdent(tree: untpd.Ident, treeKind: String, val name: Name)(using Ctx, CState)
  ...
  class TypeMismatch(found: Type, expected: Type, addenda: => String*)(using Ctx, CState)
  ...
  class NotAMember(site: Type, val name: Name, selected: String, addendum: => String = "")(using Ctx, CState)
  ...
  class EarlyDefinitionsNotSupported()(using Ctx, CState)
  ...
  class TopLevelImplicitClass(cdef: untpd.TypeDef)(using Ctx, CState)
  ...
  class ImplicitCaseClass(cdef: untpd.TypeDef)(using Ctx, CState)
  ...
  class ImplicitClassPrimaryConstructorArity()(using Ctx, CState)
  ...
  class ObjectMayNotHaveSelfType(mdef: untpd.ModuleDef)(using Ctx, CState)
  ...
  class RepeatedModifier(modifier: String)(using Ctx, CState)
  ...
  class InterpolatedStringError()(using Ctx, CState)
  ...
  class UnboundPlaceholderParameter()(using Ctx, CState)
  ...
  class IllegalStartSimpleExpr(illegalToken: String)(using Ctx, CState)
  ...
  class MissingReturnType()(using Ctx, CState)
  ...
  class MissingReturnTypeWithReturnStatement(method: Symbol)(using Ctx, CState)
  ...
  class YieldOrDoExpectedInForComprehension()(using Ctx, CState)
  ...
  class ProperDefinitionNotFound()(using Ctx, CState)
  ...
  class ByNameParameterNotSupported(tpe: untpd.TypTree)(using Ctx, CState)
  ...
  class WrongNumberOfTypeArgs(fntpe: Type, expectedArgs: List[ParamInfo], actual: List[untpd.Tree])(using Ctx, CState)
  ...
  class IllegalVariableInPatternAlternative()(using Ctx, CState)
  ...
  class IdentifierExpected(identifier: String)(using Ctx, CState)
  ...
  class AuxConstructorNeedsNonImplicitParameter()(using Ctx, CState)
  ...
  class IncorrectRepeatedParameterSyntax()(using Ctx, CState)
  ...
  class IllegalLiteral()(using Ctx, CState)
  ...
  class PatternMatchExhaustivity(uncoveredFn: => String)(using Ctx, CState)
  ...
  class UncheckedTypePattern(msgFn: => String)(using Ctx, CState)
  ...
  class MatchCaseUnreachable()(using Ctx, CState)
  ...
  class IllegalStartOfSimplePattern()(using Ctx, CState)
  ...
  class PkgDuplicateSymbol(existing: Symbol)(using Ctx, CState)
  extends NamingMsg(PkgDuplicateSymbolID) {
    def msg = em"Trying to define package with same name as $existing"
    def explain = ""
  }

  class ExistentialTypesNoLongerSupported()(using Ctx, CState)
  ...
  class UnboundWildcardType()(using Ctx, CState)
  ...
  class DanglingThisInPath()(using Ctx, CState) extends SyntaxMsg(DanglingThisInPathID) {
  ...
  class OverridesNothing(member: Symbol)(using Ctx, CState)
  ...
  class OverridesNothingButNameExists(member: Symbol, existing: List[Denotations.SingleDenotation])(using Ctx, CState)
  ...
  class ForwardReferenceExtendsOverDefinition(value: Symbol, definition: Symbol)(using Ctx, CState)
  ...
  class ExpectedTokenButFound(expected: Token, found: Token)(using Ctx, CState)
  ...
  class MixedLeftAndRightAssociativeOps(op1: Name, op2: Name, op2LeftAssoc: Boolean)(using Ctx, CState)
  ...
  class CantInstantiateAbstractClassOrTrait(cls: Symbol, isTrait: Boolean)(using Ctx, CState)
  ...
  class UnreducibleApplication(tycon: Type)(using Ctx, CState) extends TypeMsg(UnreducibleApplicationID):
  ...
  class OverloadedOrRecursiveMethodNeedsResultType(cycleSym: Symbol)(using Ctx, CState)
  ...
  class RecursiveValueNeedsResultType(cycleSym: Symbol)(using Ctx, CState)
  ...
  class CyclicReferenceInvolving(denot: SymDenotation)(using Ctx, CState)
  ...
  class CyclicReferenceInvolvingImplicit(cycleSym: Symbol)(using Ctx, CState)
  ...
  class SuperQualMustBeParent(qual: untpd.Ident, cls: ClassSymbol)(using Ctx, CState)
  ...
  class VarArgsParamMustComeLast()(using Ctx, CState)
  extends SyntaxMsg(IncorrectRepeatedParameterSyntaxID) {
  ...
  class AmbiguousReference(name: Name, newPrec: BindingPrec, prevPrec: BindingPrec, prevCtx: Ctx)(using Ctx, CState)
    ...
    /** A string which explains how something was bound; Depending on `prec` this is either
      ...
      */
    private def bindingString(prec: BindingPrec, whereFound: Ctx, qualifier: String = "") = {
  ...
  class MethodDoesNotTakeParameters(tree: tpd.Tree)(using Ctx, CState)
  ...
  class ReassignmentToVal(name: Name)(using Ctx, CState)
  ...
  class TypeDoesNotTakeParameters(tpe: Type, params: List[Trees.Tree[Trees.Untyped]])(using Ctx, CState)
  ...
  class ParameterizedTypeLacksArguments(psym: Symbol)(using Ctx, CState)
  ...
  class VarValParametersMayNotBeCallByName(name: TermName, mutable: Boolean)(using Ctx, CState)
  ...
  class MissingTypeParameterFor(tpe: Type)(using Ctx, CState)
  ...
  class MissingTypeParameterInTypeApp(tpe: Type)(using Ctx, CState)
  ...
  class DoesNotConformToBound(tpe: Type, which: String, bound: Type)(using Ctx, CState)
  ...
  class TypesAndTraitsCantBeImplicit()(using Ctx, CState)
  ...
  class CannotExtendAnyVal(sym: Symbol)(using Ctx, CState)
  ...
  class CannotHaveSameNameAs(sym: Symbol, cls: Symbol, reason: CannotHaveSameNameAs.Reason)(using Ctx, CState)
  ...
  class ValueClassesMayNotDefineInner(valueClass: Symbol, inner: Symbol)(using Ctx, CState)
    extends SyntaxMsg(ValueClassesMayNotDefineInnerID) {
    def msg = em"""Value classes may not define an inner class"""
    def explain = ""
  }

  class ValueClassesMayNotDefineNonParameterField(valueClass: Symbol, field: Symbol)(using Ctx, CState)
    extends SyntaxMsg(ValueClassesMayNotDefineNonParameterFieldID) {
    def msg = em"""Value classes may not define non-parameter field"""
    def explain = ""
  }

  class ValueClassesMayNotDefineASecondaryConstructor(valueClass: Symbol, constructor: Symbol)(using Ctx, CState)
  ...
  class ValueClassesMayNotContainInitalization(valueClass: Symbol)(using Ctx, CState)
  ...
  class ValueClassesMayNotBeAbstract(valueClass: Symbol)(using Ctx, CState)
    extends SyntaxMsg(ValueClassesMayNotBeAbstractID) {
    def msg = em"""Value classes may not be ${hl("abstract")}"""
    def explain = ""
  }

  class ValueClassesMayNotBeContainted(valueClass: Symbol)(using Ctx, CState)
  ...
  class ValueClassesMayNotWrapItself(valueClass: Symbol)(using Ctx, CState)
    extends SyntaxMsg(ValueClassesMayNotWrapItselfID) {
    def msg = """A value class may not wrap itself"""
    def explain = ""
  }

  class ValueClassParameterMayNotBeAVar(valueClass: Symbol, param: Symbol)(using Ctx, CState)
  ...
  class ValueClassNeedsOneValParam(valueClass: Symbol)(using Ctx, CState)
    extends SyntaxMsg(ValueClassNeedsExactlyOneValParamID) {
    def msg = em"""Value class needs one ${hl("val")} parameter"""
    def explain = ""
  }

  class ValueClassParameterMayNotBeCallByName(valueClass: Symbol, param: Symbol)(using Ctx, CState)
  ...
  class NotAPath(tp: Type, usage: String)(using Ctx, CState) extends TypeMsg(NotAPathID):
  ...
  class WrongNumberOfParameters(expected: Int)(using Ctx, CState)
    extends SyntaxMsg(WrongNumberOfParametersID) {
    def msg = s"Wrong number of parameters, expected: $expected"
    def explain = ""
  }

  class DuplicatePrivateProtectedQualifier()(using Ctx, CState)
  ...
  class ExpectedStartOfTopLevelDefinition()(using Ctx, CState)
  ...
  class NoReturnFromInlineable(owner: Symbol)(using Ctx, CState)
  ...
  class ReturnOutsideMethodDefinition(owner: Symbol)(using Ctx, CState)
  ...
  class ExtendFinalClass(clazz:Symbol, finalClazz: Symbol)(using Ctx, CState)
  ...
  class ExpectedTypeBoundOrEquals(found: Token)(using Ctx, CState)
  ...
  class ClassAndCompanionNameClash(cls: Symbol, other: Symbol)(using Ctx, CState)
  ...
  class TailrecNotApplicable(symbol: Symbol)(using Ctx, CState)
  ...
  class FailureToEliminateExistential(tp: Type, tp1: Type, tp2: Type, boundSyms: List[Symbol])(using Ctx, CState)
  ...
  class OnlyFunctionsCanBeFollowedByUnderscore(tp: Type)(using Ctx, CState)
  ...
  class MissingEmptyArgumentList(method: Symbol)(using Ctx, CState)
  ...
  class DuplicateNamedTypeParameter(name: Name)(using Ctx, CState)
    extends SyntaxMsg(DuplicateNamedTypeParameterID) {
    def msg = em"Type parameter $name was defined multiple times."
    def explain = ""
  }

  class UndefinedNamedTypeParameter(undefinedName: Name, definedNames: List[Name])(using Ctx, CState)
  ...
  class IllegalStartOfStatement(isModifier: Boolean)(using Ctx, CState) extends SyntaxMsg(IllegalStartOfStatementID) {
    def msg = {
  ...
  class TraitIsExpected(symbol: Symbol)(using Ctx, CState) extends SyntaxMsg(TraitIsExpectedID) {
  ...
  class TraitRedefinedFinalMethodFromAnyRef(method: Symbol)(using Ctx, CState) extends SyntaxMsg(TraitRedefinedFinalMethodFromAnyRefID) {
    def msg = em"Traits cannot redefine final $method from ${hl("class AnyRef")}."
    def explain = ""
  }

  class PackageNameAlreadyDefined(pkg: Symbol)(using Ctx, CState) extends NamingMsg(PackageNameAlreadyDefinedID) {
    lazy val (where, or) =
  ...
  class UnapplyInvalidNumberOfArguments(qual: untpd.Tree, argTypes: List[Type])(using Ctx, CState)
  ...
  class UnapplyInvalidReturnType(unapplyResult: Type, unapplyName: Name)(using Ctx, CState)
  ...
  class StaticFieldsOnlyAllowedInObjects(member: Symbol)(using Ctx, CState) extends SyntaxMsg(StaticFieldsOnlyAllowedInObjectsID) {
  ...
  class StaticFieldsShouldPrecedeNonStatic(member: Symbol, defns: List[tpd.Tree])(using Ctx, CState) extends SyntaxMsg(StaticFieldsShouldPrecedeNonStaticID) {
  ...
  class CyclicInheritance(symbol: Symbol, addendum: => String)(using Ctx, CState) extends SyntaxMsg(CyclicInheritanceID) {
  ...
  class BadSymbolicReference(denot: SymDenotation)(using Ctx, CState)
  ...
  class UnableToExtendSealedClass(pclazz: Symbol)(using Ctx, CState) extends SyntaxMsg(UnableToExtendSealedClassID) {
  ...
  class SymbolHasUnparsableVersionNumber(symbol: Symbol, errorMessage: String)(using Ctx, CState)
  ...
  )(using Ctx, CState) extends SyntaxMsg(SymbolChangedSemanticsInVersionID) {
  ...
  class UnableToEmitSwitch(tooFewCases: Boolean)(using Ctx, CState)
  ...
  class MissingCompanionForStatic(member: Symbol)(using Ctx, CState)
  ...
  class PolymorphicMethodMissingTypeInParent(rsym: Symbol, parentSym: Symbol)(using Ctx, CState)
  ...
  class ParamsNoInline(owner: Symbol)(using Ctx, CState)
    extends SyntaxMsg(ParamsNoInlineID) {
    def msg = em"""${hl("inline")} modifier can only be used for parameters of inline methods"""
    def explain = ""
  }

  class JavaSymbolIsNotAValue(symbol: Symbol)(using Ctx, CState) extends TypeMsg(JavaSymbolIsNotAValueID) {
    def msg = {
      val kind =
  ...
  class DoubleDefinition(decl: Symbol, previousDecl: Symbol, base: Symbol)(using Ctx, CState) extends NamingMsg(DoubleDefinitionID) {
    def msg = {
      def nameAnd = if (decl.name != previousDecl.name) " name and" else ""
      def details(using Ctx, CState): String =
  ...
  class ImportRenamedTwice(ident: untpd.Ident)(using Ctx, CState) extends SyntaxMsg(ImportRenamedTwiceID) {
    def msg = s"${ident.show} is renamed twice on the same import line."
    def explain = ""
  }

  class TypeTestAlwaysSucceeds(scrutTp: Type, testTp: Type)(using Ctx, CState) extends SyntaxMsg(TypeTestAlwaysSucceedsID) {
    def msg = {
      val addendum =
  ...
  class TermMemberNeedsResultTypeForImplicitSearch(cycleSym: Symbol)(using Ctx, CState)
  ...
  class ClassCannotExtendEnum(cls: Symbol, parent: Symbol)(using Ctx, CState) extends SyntaxMsg(ClassCannotExtendEnumID) {
    def msg = em"""$cls in ${cls.owner} extends enum ${parent.name}, but extending enums is prohibited."""
    def explain = ""
  }

  class NotAnExtractor(tree: untpd.Tree)(using Ctx, CState) extends SyntaxMsg(NotAnExtractorID) {
  ...
  class MemberWithSameNameAsStatic()(using Ctx, CState)
  ...
  class PureExpressionInStatementPosition(stat: untpd.Tree, val exprOwner: Symbol)(using Ctx, CState)
  ...
  class OverloadInRefinement(rsym: Symbol)(using Ctx, CState)
  ...
  class NoMatchingOverload(val alternatives: List[SingleDenotation], pt: Type)(using Ctx, CState)
  ...
  class StableIdentPattern(tree: untpd.Tree, pt: Type)(using Ctx, CState)
  ...
  class IllegalSuperAccessor(base: Symbol, memberName: Name,
      ...
      other: Symbol, otherTp: Type)(using Ctx, CState) extends DeclarationMsg(IllegalSuperAccessorID) {
    def msg = {
  ...
  class TraitParameterUsedAsParentPrefix(cls: Symbol)(using Ctx, CState)
  ...
  class UnknownNamedEnclosingClassOrObject(name: TypeName)(using Ctx, CState)
  ...
  class IllegalCyclicTypeReference(sym: Symbol, where: String, lastChecked: Type)(using Ctx, CState)
  ...
  class ErasedTypesCanOnlyBeFunctionTypes()(using Ctx, CState)
    extends SyntaxMsg(ErasedTypesCanOnlyBeFunctionTypesID) {
    def msg = "Types with erased keyword can only be function types `(erased ...) => ...`"
    def explain = ""
  }

  class CaseClassMissingNonImplicitParamList(cdef: untpd.TypeDef)(using Ctx, CState)
  ...
  class EnumerationsShouldNotBeEmpty(cdef: untpd.TypeDef)(using Ctx, CState)
  ...
  class AbstractCannotBeUsedForObjects(mdef: untpd.ModuleDef)(using Ctx, CState)
  ...
  class ModifierRedundantForObjects(mdef: untpd.ModuleDef, modifier: String)(using Ctx, CState)
  ...
  class TypedCaseDoesNotExplicitlyExtendTypedEnum(enumDef: Symbol, caseDef: untpd.TypeDef)(using Ctx, CState)
  ...
  class IllegalRedefinitionOfStandardKind(kindType: String, name: Name)(using Ctx, CState)
  ...
  class NoExtensionMethodAllowed(mdef: untpd.DefDef)(using Ctx, CState)
  ...
  class ExtensionMethodCannotHaveTypeParams(mdef: untpd.DefDef)(using Ctx, CState)
  ...
  class ExtensionCanOnlyHaveDefs(mdef: untpd.Tree)(using Ctx, CState)
  ...
  class UnexpectedPatternForSummonFrom(tree: Tree[_])(using Ctx, CState)
  ...
  class AnonymousInstanceCannotBeEmpty(impl:  untpd.Template)(using Ctx, CState)
  ...
  class TypeSpliceInValPattern(expr:  untpd.Tree)(using Ctx, CState)
  ...
  class ModifierNotAllowedForDefinition(flag: Flag)(using Ctx, CState)
