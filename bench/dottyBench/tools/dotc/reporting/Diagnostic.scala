...
object Diagnostic:
  ...
  def shouldExplain(dia: Diagnostic)(using Ctx): Boolean =
  ...
  abstract class ConditionalWarning(
    ...
    def enablingOption(using Ctx): Setting[Boolean]
  }
  ...
  class FeatureWarning(
    ...
    def enablingOption(using Ctx): Setting[Boolean] = ctx.settings.feature
  }
  ...
  class UncheckedWarning(
    ...
    def enablingOption(using Ctx): Setting[Boolean] = ctx.settings.unchecked
  }
  ...
  class DeprecationWarning(
    ...
    def enablingOption(using Ctx): Setting[Boolean] = ctx.settings.deprecation
  }
  ...
  class MigrationWarning(
    ...
    def enablingOption(using Ctx): Setting[Boolean] = ctx.settings.migration
  }
