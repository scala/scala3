...
class PatternMatcher extends MiniPhase {
  ...
  override def transformMatch(tree: Match)(using Ctx, CState): Tree =
...
object PatternMatcher {
  ...
  def isPatmatGenerated(sym: Symbol)(using Ctx, CState): Boolean =
   ...
   */
  class Translator(resultType: Type, thisPhase: MiniPhase)(using Ctx, CState) {
