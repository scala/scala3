...
object ContextFunctionResults:
   ...
   */
  def annotateContextResults(mdef: DefDef)(using Ctx, CState): Unit =
   ...
   */
  def contextResultCount(sym: Symbol)(using Ctx, CState): Int =
   ...
   */
  def integrateContextResults(tp: Type, crCount: Int)(using Ctx, CState): Type =
   ...
   */
  def totalParamCount(sym: Symbol)(using Ctx, CState): Int =
   ...
   *  parameter count.
   */
  def contextFunctionResultTypeCovering(meth: Symbol, paramCount: Int)(using Ctx, CState) =
   ...
   */
  def integrateSelect(tree: untpd.Tree, n: Int = 0)(using Ctx, CState): Boolean =
