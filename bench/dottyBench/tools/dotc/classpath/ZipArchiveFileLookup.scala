...
import dottyBench.tools.io.{ AbstractFile, FileZipArchive }
import FileUtils.AbstractFileOps
import dottyBench.tools.io.{ClassPath, ClassRepresentation}
...
trait ZipArchiveFileLookup[FileEntryType <: ClassRepresentation] extends ClassPath {
  ...
  override private[dottyBench] def hasPackage(pkg: String): Boolean = findDirEntry(pkg).isDefined
