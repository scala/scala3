...
import dottyBench.tools.dotc.core.Flags.FlagSet
...
object JavaParsers {
  ...
  class JavaParser(source: SourceFile)(using Ctx, CState) extends ParserCommon(source) {
...
//        }
   ...
   *  classname alone.
   */
  class OutlineJavaParser(source: SourceFile)(using Ctx, CState) extends JavaParser(source) with OutlineParserCommon {
