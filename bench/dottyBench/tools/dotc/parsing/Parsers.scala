...
object Parsers {
   ...
   */
  def parser(source: SourceFile)(using Ctx, CState): Parser =
  ...
  abstract class ParserCommon(val source: SourceFile)(using Ctx, CState) {
    ...
    def unimplementedExpr(using Ctx, CState): Select =
  ...
  class Parser(source: SourceFile)(using Ctx, CState) extends ParserCommon(source) {
...
/* -------- STATSEQS ------------------------------------------- */
   ...
   */
  class OutlineParser(source: SourceFile)(using Ctx, CState) extends Parser(source) with OutlineParserCommon {
