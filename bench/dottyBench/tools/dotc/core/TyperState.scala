...
class TyperState() {
  ...
  def constraint_=(c: Constraint)(using Ctx, CState): Unit = {
   ...
   */
  def commit()(using Ctx, CState): Unit = {
  ...
  def mergeConstraintWith(that: TyperState)(using Ctx, CState): Unit =
