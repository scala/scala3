...
object Checking {
   ...
   */
  private def showInferred(msg: Message, app: Type, tpt: Tree)(using Ctx, CState): Message =
  ...
  def checkBounds(args: List[tpd.Tree], boundss: List[TypeBounds],
    instantiate: (Type, List[Type]) => Type, app: Type = NoType, tpt: Tree = EmptyTree)(using Ctx, CState): Unit =
   ...
   */
  def checkBounds(args: List[tpd.Tree], tl: TypeLambda)(using Ctx, CState): Unit =
   ...
   */
  def checkAppliedType(tree: AppliedTypeTree, tpt: Tree = EmptyTree)(using Ctx, CState): Unit = {
    ...
    def checkValidIfApply(using Ctx, CState): Unit =
  ...
  def checkAppliedTypesIn(tpt: TypeTree)(using Ctx, CState): Unit =
  ...
  def checkNoWildcard(tree: Tree)(using Ctx, CState): Tree = tree.tpe match {
   ...
   */
  def preCheckKind(arg: Tree, paramBounds: Type)(using Ctx, CState): Tree =
  ...
  def preCheckKinds(args: List[Tree], paramBoundss: List[Type])(using Ctx, CState): List[Tree] = {
   ...
   */
  def checkInstantiable(tp: Type, posd: Positioned)(using Ctx, CState): Unit =
  ...
  def checkRealizable(tp: Type, posd: Positioned, what: String = "path")(using Ctx, CState): Unit = {
   ...
   */
  class CheckNonCyclicMap(sym: Symbol, reportErrors: Boolean)(using Ctx, CState) extends TypeMap {
   ...
   */
  def checkValidOperator(sym: Symbol)(using Ctx, CState): Unit =
   ...
   */
  def checkNonCyclic(sym: Symbol, info: Type, reportErrors: Boolean)(using Ctx, CState): Type = {
  ...
  def checkRefinementNonCyclic(refinement: Tree, refineCls: ClassSymbol, seen: mutable.Set[Symbol])
    ...
    val checkTree = new TreeAccumulator[Unit] {
      ...
      def apply(x: Unit, tree: Tree)(using Ctx, CState) = tree match {
        case tree: MemberDef =>
          foldOver(x, tree)
          seen += tree.symbol
   ...
   */
  def checkNonCyclicInherited(joint: Type, parents: List[Type], decls: Scope, posd: Positioned)(using Ctx, CState): Unit = {
  ...
  def checkWellFormed(sym: Symbol)(using Ctx, CState): Unit = {
   ...
   */
  def checkNoPrivateLeaks(sym: Symbol)(using Ctx, CState): Type = {
  ...
  def checkDerivedValueClass(clazz: Symbol, stats: List[Tree])(using Ctx, CState): Unit = {
  ...
  def checkEnumParentOK(cls: Symbol)(using Ctx, CState): Unit =
    val enumCase =
  ...
  def checkInlineOverrideParameters(sym: Symbol)(using Ctx, CState): Unit =
...
trait Checking {
  ...
  def checkNonCyclic(sym: Symbol, info: TypeBounds, reportErrors: Boolean)(using Ctx, CState): Type =
  ...
  def checkStable(tp: Type, pos: SourcePosition, kind: String)(using Ctx, CState): Unit =
    if !tp.isStable then report.error(NotAPath(tp, kind), pos)

  /** Check that all type members of `tp` have realizable bounds */
  def checkRealizableBounds(cls: Symbol, pos: SourcePosition)(using Ctx, CState): Unit = {
   ...
   */
  def checkIrrefutable(pat: Tree, pt: Type, isPatDef: Boolean)(using Ctx, CState): Boolean = {
  ...
  def checkLegalImportPath(path: Tree)(using Ctx, CState): Unit = {
  ...
  *   check that class prefix is stable.
   ...
   */
  def checkClassType(tp: Type, pos: SourcePosition, traitReq: Boolean, stablePrefixReq: Boolean)(using Ctx, CState): Type =
    tp.underlyingClassRef(refinementOK = false) match {
      case tref: TypeRef =>
   ...
   */
  def checkImplicitConversionDefOK(sym: Symbol)(using Ctx, CState): Unit = {
    def check(): Unit =
      checkFeature(
   ...
   */
  def checkImplicitConversionUseOK(sym: Symbol, posd: Positioned)(using Ctx, CState): Unit =
    if (sym.exists) {
      val conv =
   ...
   */
  def checkValidInfix(tree: untpd.InfixOp, meth: Symbol)(using Ctx, CState): Unit = {
    tree.op match {
  ...
  def checkFeature(name: TermName,
                   ...
                   pos: SourcePosition)(using Ctx, CState): Unit =
   ...
   */
  def checkFeasibleParent(tp: Type, pos: SourcePosition, where: => String = "")(using Ctx, CState): Type = {
  ...
  def checkInlineConformant(tpt: Tree, tree: Tree, sym: Symbol)(using Ctx, CState): Unit = {
  ...
  def excludeFromDoubleDeclCheck(sym: Symbol)(using Ctx, CState): Boolean = false

  /** Check that class does not declare same symbol twice */
  def checkNoDoubleDeclaration(cls: Symbol)(using Ctx, CState): Unit = {
  ...
  def checkParentCall(call: Tree, caller: ClassSymbol)(using Ctx, CState): Unit =
  ...
  def checkSimpleKinded(tpt: Tree)(using Ctx, CState): Tree =
  ...
  def checkSignatureRepeatedParam(sym: Symbol)(using Ctx, CState): Unit =
   ...
   */
  def checkTraitInheritance(parent: Symbol, cls: ClassSymbol, pos: SourcePosition)(using Ctx, CState): Unit =
    parent match {
   ...
   */
  def checkCaseInheritance(parent: Symbol, caseCls: ClassSymbol, pos: SourcePosition)(using Ctx, CState): Unit =
    parent match {
   ...
   */
  def checkNoForwardDependencies(vparams: List[ValDef])(using Ctx, CState): Unit = vparams match {
   ...
   */
  def checkMembersOK(tp: Type, pos: SourcePosition)(using Ctx, CState): Type = {
    var ok = true
    val check: Type => Unit = {
      case ref: NamedType =>
   ...
   *  to `badOwner`.
   */
  def checkRefsLegal(tree: tpd.Tree, badOwner: Symbol, allowed: (Name, Symbol) => Boolean, where: String)(using Ctx, CState): Unit = {
    val checker = new TreeTraverser {
      def traverse(t: Tree)(using Ctx, CState) = {
  ...
  def checkFullyAppliedType(tree: Tree)(using Ctx, CState): Unit = tree match
  ...
  def checkInInlineContext(what: String, posd: Positioned)(using Ctx, CState): Unit =
   ...
   */
  def checkEnum(cdef: untpd.TypeDef, cls: Symbol, firstParent: Symbol)(using Ctx, CState): Unit = {
    def isEnumAnonCls =
   ...
   */
  def checkEnumCaseRefsLegal(cdef: TypeDef, enumCtx: Ctx)(using Ctx, CState): Unit = {

    def checkCaseOrDefault(stat: Tree, caseCtx: Ctx) = {
  ...
  def checkAnnotApplicable(annot: Tree, sym: Symbol)(using Ctx, CState): Boolean =
  ...
  def checkNoAlphaConflict(stats: List[Tree])(using Ctx, CState): Unit = {
    var seen = Set[Name]()
    for (stat <- stats) {
      val sym = stat.symbol
...
trait ReChecking extends Checking {
  import tpd._
  override def checkEnum(cdef: untpd.TypeDef, cls: Symbol, firstParent: Symbol)(using Ctx, CState): Unit = ()
  override def checkRefsLegal(tree: tpd.Tree, badOwner: Symbol, allowed: (Name, Symbol) => Boolean, where: String)(using Ctx, CState): Unit = ()
  override def checkFullyAppliedType(tree: Tree)(using Ctx, CState): Unit = ()
  override def checkEnumCaseRefsLegal(cdef: TypeDef, enumCtx: Ctx)(using Ctx, CState): Unit = ()
  override def checkAnnotApplicable(annot: Tree, sym: Symbol)(using Ctx, CState): Boolean = true
}

trait NoChecking extends ReChecking {
  import tpd._
  override def checkNonCyclic(sym: Symbol, info: TypeBounds, reportErrors: Boolean)(using Ctx, CState): Type = info
  override def checkNonCyclicInherited(joint: Type, parents: List[Type], decls: Scope, posd: Positioned)(using Ctx, CState): Unit = ()
  override def checkStable(tp: Type, pos: SourcePosition, kind: String)(using Ctx, CState): Unit = ()
  override def checkClassType(tp: Type, pos: SourcePosition, traitReq: Boolean, stablePrefixReq: Boolean)(using Ctx, CState): Type = tp
  override def checkImplicitConversionDefOK(sym: Symbol)(using Ctx, CState): Unit = ()
  override def checkImplicitConversionUseOK(sym: Symbol, posd: Positioned)(using Ctx, CState): Unit = ()
  override def checkFeasibleParent(tp: Type, pos: SourcePosition, where: => String = "")(using Ctx, CState): Type = tp
  override def checkInlineConformant(tpt: Tree, tree: Tree, sym: Symbol)(using Ctx, CState): Unit = ()
  override def checkNoAlphaConflict(stats: List[Tree])(using Ctx, CState): Unit = ()
  override def checkParentCall(call: Tree, caller: ClassSymbol)(using Ctx, CState): Unit = ()
  override def checkSimpleKinded(tpt: Tree)(using Ctx, CState): Tree = tpt
  override def checkDerivedValueClass(clazz: Symbol, stats: List[Tree])(using Ctx, CState): Unit = ()
  override def checkTraitInheritance(parentSym: Symbol, cls: ClassSymbol, pos: SourcePosition)(using Ctx, CState): Unit = ()
  override def checkCaseInheritance(parentSym: Symbol, caseCls: ClassSymbol, pos: SourcePosition)(using Ctx, CState): Unit = ()
  override def checkNoForwardDependencies(vparams: List[ValDef])(using Ctx, CState): Unit = ()
  override def checkMembersOK(tp: Type, pos: SourcePosition)(using Ctx, CState): Type = tp
  override def checkInInlineContext(what: String, posd: Positioned)(using Ctx, CState): Unit = ()
  override def checkValidInfix(tree: untpd.InfixOp, meth: Symbol)(using Ctx, CState): Unit = ()
  override def checkFeature(name: TermName, description: => String, featureUseSite: Symbol, pos: SourcePosition)(using Ctx, CState): Unit = ()
}
