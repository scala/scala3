...
/**
  ...
  */
trait ClassPath {
  import dottyBench.tools.dotc.classpath._
  def asURLs: Seq[URL]
  ...
  private[dottyBench] def hasPackage(pkg: String): Boolean
  ...
  private[dottyBench] def sources(inPackage: String): Seq[SourceFileEntry]
