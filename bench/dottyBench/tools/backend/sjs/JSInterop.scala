...
object JSInterop {
  ...
  def isJSType(sym: Symbol)(using Ctx, CState): Boolean = {
  ...
  def isScalaJSDefinedJSClass(sym: Symbol)(using Ctx, CState): Boolean =
   ...
   */
  def isJSGetter(sym: Symbol)(using Ctx, CState): Boolean = {
   ...
   */
  def isJSSetter(sym: Symbol)(using Ctx, CState): Boolean =
   ...
   */
  def isJSBracketAccess(sym: Symbol)(using Ctx, CState): Boolean =
   ...
   */
  def isJSBracketCall(sym: Symbol)(using Ctx, CState): Boolean =
   ...
   *  is a JS type.
   */
  def isJSDefaultParam(sym: Symbol)(using Ctx, CState): Boolean = {
   ...
   */
  def jsNameOf(sym: Symbol)(using Ctx, CState): String = {
   ...
   */
  def fullJSNameOf(sym: Symbol)(using Ctx, CState): String = {
