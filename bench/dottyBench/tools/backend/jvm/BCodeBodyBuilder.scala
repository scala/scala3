...
import dottyBench.tools.dotc.core.Flags.{Label => LabelFlag, _}
import dottyBench.tools.dotc.core.Types._
import dottyBench.tools.dotc.core.StdNames.{nme, str}
        ...
        case app: Closure =>
          ...
          val functionalInterface: Symbol = {
            ...
            if (t.exists) t
              ...
              if (returnsUnit) requiredClass(("dottyBench.runtime.function.JProcedure" + arity))
              else if (arity <= 2) requiredClass(("dottyBench.runtime.function.JFunction" + arity))
