...
trait Resources(using ctx: DocContext) extends Locations, Writer:
  ...
  def allResources(pages: Seq[Page]): Seq[Resource] =
    ...
    Seq(
      ...
      dottyRes("images/arrow-down-dark-active.svg"),
      dottyRes("images/arrow-down-dark-selected.svg"),
      dottyRes("images/arrow-down-dark.svg"),
      dottyRes("images/arrow-down-selected.svg"),
      dottyRes("images/arrow-down.svg"),
      dottyRes("images/arrow-right-dark-active.svg"),
      dottyRes("images/arrow-right-dark-selected.svg"),
