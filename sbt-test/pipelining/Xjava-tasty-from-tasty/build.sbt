...
lazy val a = project.in(file("a"))
  .settings(
    ...
    scalacOptions ++= Seq("-Xearly-tasty-output", ((ThisBuild / baseDirectory).value / "a-pre-java-tasty.jar").toString),
...
// Requires -Xjava-tasty to be set in order to read them.
lazy val a_from_tasty = project.in(file("a_from_tasty"))
  .settings(
    ...
    scalacOptions ++= Seq("-Xearly-tasty-output", ((ThisBuild / baseDirectory).value / "a_from_tasty-java-tasty.jar").toString),
    scalacOptions += "-Ycheck:all",
