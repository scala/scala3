class S {
  ...
  locally {
    ...
    val z2: Array[String | Null] = y1
    val z3: Array[String] | Null = y1
    val z4: Array[String | Null] | Null = y1

    val z5: Array[String] = y2
    val z6: Array[String | Null] = y2
    val z7: Array[String] | Null = y2
    val z8: Array[String | Null] | Null = y2
  }
