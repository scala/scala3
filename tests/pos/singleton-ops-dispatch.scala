...
import scala.annotation.checked.uncheckedVariance

object Test {
  @infix type +[+X <: Int & Singleton | String & Singleton, +Y <: Int & Singleton | String & Singleton] = (X @uncheckedVariance, Y @uncheckedVariance) match {
