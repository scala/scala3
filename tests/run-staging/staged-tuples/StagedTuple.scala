...
object StagedTuple {
  ...
  def toArrayStaged(tup: Expr[Tuple], size: Option[Int]) with QuoteContext : Expr[Array[Object]] = {
  ...
  def fromArrayStaged[T <: Tuple : Type](xs: Expr[Array[Object]], size: Option[Int]) with QuoteContext : Expr[T] = {
  ...
  def sizeStaged[Res <: Int : Type](tup: Expr[Tuple], size: Option[Int]) with QuoteContext : Expr[Res] = {
    val res =
  ...
  def headStaged[Tup <: NonEmptyTuple : Type](tup: Expr[Tup], size: Option[Int]) with QuoteContext : Expr[Head[Tup]] = {
  ...
  def tailStaged[Tup <: NonEmptyTuple : Type](tup: Expr[Tup], size: Option[Int]) with QuoteContext : Expr[Tail[Tup]] = {
  ...
  def applyStaged[Tup <: NonEmptyTuple : Type, N <: Int : Type](tup: Expr[Tup], size: Option[Int], n: Expr[N], nValue: Option[Int]) with (qctx: QuoteContext) : Expr[Elem[Tup, N]] = {
    import reflect._
  ...
  def consStaged[T <: Tuple & Singleton : Type, H : Type](self: Expr[T], x: Expr[H], tailSize: Option[Int]) with QuoteContext : Expr[H *: T] =
  ...
  def concatStaged[Self <: Tuple & Singleton : Type, That <: Tuple & Singleton : Type](self: Expr[Self], selfSize: Option[Int], that: Expr[That], thatSize: Option[Int]) with QuoteContext : Expr[Concat[Self, That]] = {
  ...
  private implicit class ExprOps[U: Type](expr: Expr[U]) {
    ...
    def as[T: Type] with QuoteContext : Expr[T] = '{ $expr.asInstanceOf[T] }

    def bind[T: Type](in: Expr[U] => Expr[T]) with QuoteContext : Expr[T] = '{
      val t: U = $expr
      ${in('t)}
    }
  }
