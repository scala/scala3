...
object StagedTuple {
  ...
  def fromArrayStaged[T <: Tuple : TypeTag](xs: Expr[Array[Object]], size: Option[Int])(given QuoteContext): Expr[T] = {
  ...
  def sizeStaged[Res <: Int : TypeTag](tup: Expr[Tuple], size: Option[Int])(given QuoteContext): Expr[Res] = {
    val res =
  ...
  def headStaged[Tup <: NonEmptyTuple : TypeTag](tup: Expr[Tup], size: Option[Int])(given QuoteContext): Expr[Head[Tup]] = {
  ...
  def tailStaged[Tup <: NonEmptyTuple : TypeTag](tup: Expr[Tup], size: Option[Int])(given QuoteContext): Expr[Tail[Tup]] = {
  ...
  def applyStaged[Tup <: NonEmptyTuple : TypeTag, N <: Int : TypeTag](tup: Expr[Tup], size: Option[Int], n: Expr[N], nValue: Option[Int])(given qctx: QuoteContext): Expr[Elem[Tup, N]] = {
    import reflect._
  ...
  def consStaged[T <: Tuple & Singleton : TypeTag, H : TypeTag](self: Expr[T], x: Expr[H], tailSize: Option[Int])(given QuoteContext): Expr[H *: T] =
  ...
  def concatStaged[Self <: Tuple & Singleton : TypeTag, That <: Tuple & Singleton : TypeTag](self: Expr[Self], selfSize: Option[Int], that: Expr[That], thatSize: Option[Int])(given QuoteContext): Expr[Concat[Self, That]] = {
  ...
  private implicit class ExprOps[U: TypeTag](expr: Expr[U]) {

    def as[T: TypeTag](given QuoteContext): Expr[T] = '{ $expr.asInstanceOf[T] }

    def bind[T: TypeTag](in: Expr[U] => Expr[T])(given QuoteContext): Expr[T] = '{
      val t: U = $expr
      ${in('t)}
    }
  }
