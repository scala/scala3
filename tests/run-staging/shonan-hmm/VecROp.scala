...
class VecRDyn[T: TypeTag](given QuoteContext) extends VecDyn with VecROp[Expr[Int], Expr[T], Expr[Unit]] {
...
class VecRStaDim[T: TypeTag](r: Ring[T])(given QuoteContext) extends VecROp[Int, T, Expr[Unit]]  {
...
class VecRStaDyn[T : TypeTag : Liftable](r: Ring[PV[T]])(given QuoteContext) extends VecROp[PV[Int], PV[T], Expr[Unit]] {
