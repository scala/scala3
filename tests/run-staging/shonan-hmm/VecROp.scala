...
class VecRDyn[T: Staged](using QuoteContext) extends VecDyn with VecROp[Expr[Int], Expr[T], Expr[Unit]] {
...
class VecRStaDim[T: Staged](r: Ring[T])(using QuoteContext) extends VecROp[Int, T, Expr[Unit]]  {
...
class VecRStaDyn[T : Staged : Liftable](r: Ring[PV[T]])(using QuoteContext) extends VecROp[PV[Int], PV[T], Expr[Unit]] {
...
class VecRStaOptDynInt(r: Ring[PV[Int]]) (using QuoteContext) extends VecRStaDyn(r) {
