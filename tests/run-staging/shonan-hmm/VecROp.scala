...
class VecRDyn[T: Type] with QuoteContext extends VecDyn with VecROp[Expr[Int], Expr[T], Expr[Unit]] {
...
class VecRStaDim[T: Type](r: Ring[T]) with QuoteContext extends VecROp[Int, T, Expr[Unit]]  {
...
class VecRStaDyn[T : Type : Liftable](r: Ring[PV[T]]) with QuoteContext extends VecROp[PV[Int], PV[T], Expr[Unit]] {
...
class VecRStaOptDynInt(r: Ring[PV[Int]]) with QuoteContext extends VecRStaDyn(r) {
