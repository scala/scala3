...
object MVmult {
  ...
  def mvmult_c with QuoteContext : Expr[(Array[Int], Array[Array[Int]], Array[Int]) => Unit] = '{
    (vout, a, v) => {
      val n = vout.length
      val m = v.length
      ${
  ...
  def mvmult_mc(n: Int, m: Int) with QuoteContext : Expr[(Array[Int], Array[Array[Int]], Array[Int]) => Unit] = {
  ...
  def mvmult_ac(a: Array[Array[Int]]) with QuoteContext : Expr[(Array[Int], Array[Int]) => Unit] = {
    import Lifters._
    '{
      val arr = ${a}
      ${
  ...
  def mvmult_opt(a: Array[Array[Int]]) with QuoteContext : Expr[(Array[Int], Array[Int]) => Unit] = {
    import Lifters._
    '{
      val arr = ${a}
      ${
  ...
  def mvmult_roll(a: Array[Array[Int]]) with QuoteContext : Expr[(Array[Int], Array[Int]) => Unit] = {
    import Lifters._
    '{
      val arr = ${a}
      ${
  ...
  def mvmult_let1(a: Array[Array[Int]]) with QuoteContext : Expr[(Array[Int], Array[Int]) => Unit] = {
    val (n, m, a2) = amatCopy(a, copy_row1)
    mvmult_abs0(new RingIntOPExpr, new VecRStaOptDynInt(new RingIntPExpr))(n, m, a2)
  }

  def mvmult_let(a: Array[Array[Int]]) with QuoteContext : Expr[(Array[Int], Array[Int]) => Unit] = {
    initRows(a) { rows =>
  ...
  def initRows[T: Type](a: Array[Array[Int]])(cont: Array[Expr[Array[Int]]] => Expr[T]) with QuoteContext : Expr[T] = {
    import Lifters._
  ...
  def amat1(a: Array[Array[Int]], aa: Expr[Array[Array[Int]]]) with QuoteContext : (Int, Int, Vec[PV[Int], Vec[PV[Int], PV[Int]]]) = {
    val n = a.length
    val m = a(0).length
  ...
  def amat2(a: Array[Array[Int]], refs: Array[Expr[Array[Int]]]) with QuoteContext : (Int, Int, Vec[PV[Int], Vec[PV[Int], PV[Int]]]) = {
    val n = a.length
    val m = a(0).length
    val vec: Vec[PV[Int], Vec[PV[Int], PV[Int]]] = Vec(Sta(n), i => Vec(Sta(m), j => (i, j) match {
      case (Sta(i), Sta(j)) => Sta(a(i)(j))
  ...
  def amatCopy(a: Array[Array[Int]], copyRow: Array[Int] => (Expr[Int] => Expr[Int])) with QuoteContext : (Int, Int, Vec[PV[Int], Vec[PV[Int], PV[Int]]]) = {
    val n = a.length
    val m = a(0).length
    val vec: Vec[PV[Int], Vec[PV[Int], PV[Int]]] = Vec(Sta(n), i => Vec(Sta(m), j => (i, j) match {
      case (Sta(i), Sta(j)) => Sta(a(i)(j))
  ...
  def copy_row1 with QuoteContext : Array[Int] => (Expr[Int] => Expr[Int]) = v => {
    import Lifters._
    val arr = v
    i => '{ ($arr).apply($i) }
  }

  def copy_row_let with QuoteContext : Array[Int] => (Expr[Int] => Expr[Int]) = v => {
    import Lifters._
    val arr: Expr[Array[Int]] = ??? // FIXME used genlet v
    i => '{ ($arr).apply($i) }
  }

  private def mvmult_abs0(ring: Ring[PV[Int]], vecOp: VecROp[PV[Int], PV[Int], Expr[Unit]])(n: Int, m: Int, a: Vec[PV[Int], Vec[PV[Int], PV[Int]]]) with QuoteContext : Expr[(Array[Int], Array[Int]) => Unit] = {
    '{
      (vout, v) => {
        if (${n} != vout.length) throw new IndexOutOfBoundsException(${n.toString})
        if (${m} != v.length) throw new IndexOutOfBoundsException(${m.toString})
