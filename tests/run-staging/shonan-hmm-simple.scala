...
object Complex
  implicit def isLiftable[T: TypeTag: Liftable]: Liftable[Complex[T]] = new Liftable[Complex[T]] {
...
class ExprVecOps[T: TypeTag](given QuoteContext) extends VecOps[Expr[Int], Expr[T]]
