...
@main def main =
    ...
    val a = new Foo[Int] with Baz[Int] {} // error: Anonymous classes acting as instances of Specialized traits may not mix in other traits; you can make a named object instead if you like.
