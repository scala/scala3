...
object Test extends App {
  ...
  implicit for Exp[Int] {
    def lit(i: Int): Int = i
    def neg(t: Int): Int = -t
    def add(l: Int, r: Int): Int = l + r
  }

  implicit for Exp[String] {
  ...
  implicit for Mult[Int] {
    def mul(l: Int, r: Int): Int = l * r
  }

  implicit for Mult[String] {
  ...
  implicit for Exp[Tree], Mult[Tree] {
  ...
  implicit [T] for Exp[NCtx => T] given (e: Exp[T]) {
    import NCtx._
    def lit(i: Int) = {
      case Pos => e.lit(i)
  ...
  implicit [T] for Mult[NCtx => T] given (e: Mult[T]) {
    import NCtx._
  ...
  implicit initialize for Exp[IExp] {
