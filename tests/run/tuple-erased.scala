object Test {
  def main(args: Array[String]): Unit = {
    ...
    assert(t02.asInstanceOf[*:[?, ?]] == t02)
    assert(t05.asInstanceOf[*:[?, ?]] == t05)
    assert(t21.asInstanceOf[*:[?, ?]] == t21)
    assert(t22.asInstanceOf[*:[?, ?]] == t22)
    assert(t23.asInstanceOf[*:[?, ?]] == t23)
    assert(t24.asInstanceOf[*:[?, ?]] == t24)

    assert(t02.isInstanceOf[*:[?, ?]])
    assert(t05.isInstanceOf[*:[?, ?]])
    assert(t21.isInstanceOf[*:[?, ?]])
    assert(t22.isInstanceOf[*:[?, ?]])
    assert(t23.isInstanceOf[*:[?, ?]])
    assert(t24.isInstanceOf[*:[?, ?]])
