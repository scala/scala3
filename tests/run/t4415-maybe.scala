...
object SubclassMatch {
  ...
  def unapply(prop: SubclassProperty) : MyProp[String]? = {
    new MyPropImpl
  }
...
object StandardMatch {
  ...
  def unapply(prop: StandardProperty) : MyProp[String]? = {
    new MyPropImpl
  }
...
object SubclassSecondMatch {
  ...
  def unapply(prop: SubclassSecondProperty) : MyProp[BigInt]? = {
    new MyPropImpl
  }
...
object SecondMatch {
  ...
  def unapply(prop: SecondProperty) : MyProp[BigInt]? = {
    new MyPropImpl
  }
