...
object Generic {
  ...
  given showGen[T] with Generic as Show[T] = new Show[T](2)
}
...
object Contextual {
  ...
  given showGen[T] with (Generic, Context) as Show[T] = new Show[T](3)

  given showGen[T] with SubGen as Show[T] = new Show[T](4)
}
