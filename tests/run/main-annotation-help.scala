...
object myProgram:
  ...
  /**
    * Adds two numbers.
    */
  @newMain def doc1(num: Int, inc: Int): Unit = ()

  /** Adds two numbers. */
  @newMain def doc2(num: Int, inc: Int): Unit = ()

  /**
    *                       Adds two numbers.
    */
  @newMain def doc3(num: Int, inc: Int): Unit = ()
  ...
  /**
    ...
    */
  @newMain def doc4(num: Int, inc: Int = 1): Unit = ()
  ...
  /**
    ...
    * @param num the first number
    */
  @newMain def doc5(num: Int, inc: Int): Unit = ()
  ...
  /**
    ...
    * @param inc
    */
  @newMain def doc6(num: Int, inc: Int): Unit = ()
  ...
  /**
    ...
    */
  @newMain def doc7(num: Int, inc: Int): Unit = ()
  ...
  /**
    ...
    * @return                        the sum of the two numbers (not really)
    */
  @newMain def doc8(num: Int, inc: Int): Unit = ()
  ...
  /**
    ...
    * @see [[doc1]]
    */
  @newMain def doc9(num: Int, inc: Int): Unit = ()
  ...
  /**
    ...
    * on three lines
    */
  @newMain def doc10(num: Int, inc: Int): Unit = ()
  ...
  /**
    ...
    *                               And another one!
    */
  @newMain def doc11(num: Int, inc: Int): Unit = ()
  ...
  /**
    ...
    */
  @newMain def doc12(num: Int, inc: Int): Unit = ()
  ...
  /**
    ...
    */
  @newMain def doc13(num: Int, inc: Int): Unit = ()
  ...
  /**
    ...
    */
  @newMain def doc15(myNum: MyNumber, myInc: MyNumber): Unit = ()
  ...
  /**
    ...
    */
  @newMain def doc16(first: MyGeneric[Int], second: MyGeneric[Int]): Unit = ()

  // This should not be printed in explain!
  @newMain def doc17(a: Int, b: Int, c: String): Unit = ()
