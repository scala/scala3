...
object TypeToolbox {
  ...
  private def tpEqImpl[A, B](a: Staged[A], b: Staged[B])(using qctx: QuoteContext) : Expr[Boolean] = {
    import qctx.tasty._
  ...
  private def tpLEqImpl[A, B](a: Staged[A], b: Staged[B])(using qctx: QuoteContext) : Expr[Boolean] = {
    import qctx.tasty._
    Expr(a.unseal.tpe <:< b.unseal.tpe)
  }
  ...
  private def typeOfImpl(a: Expr[_], expected: Staged[_])(using qctx: QuoteContext) : Expr[Boolean] = {
    import qctx.tasty._
  ...
  private def isCaseClassImpl(tp: Staged[_])(using qctx: QuoteContext) : Expr[Boolean] = {
    import qctx.tasty._
  ...
  private def caseFieldsImpl(tp: Staged[_])(using qctx: QuoteContext) : Expr[List[String]] = {
    import qctx.tasty._
  ...
  private def fieldInImpl(t: Staged[_], mem: Expr[String])(using qctx: QuoteContext) : Expr[String] = {
    import qctx.tasty._
  ...
  private def fieldsInImpl(t: Staged[_])(using qctx: QuoteContext) : Expr[Seq[String]] = {
    import qctx.tasty._
  ...
  private def companionImpl(t1: Staged[_], t2: Staged[_])(using qctx: QuoteContext) : Expr[Boolean] = {
    import qctx.tasty._
  ...
  private def companionNameImpl(tp: Staged[_])(using qctx: QuoteContext) : Expr[String] = {
    import qctx.tasty._
    val sym = tp.unseal.symbol
    val companionClass =
