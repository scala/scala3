...
object Transformation {
  ...
  def safe[T: Staged](transform: PartialFunction[Expr[T], Expr[T]]): Transformation =
...
class CheckedTransformation(transform: PartialFunction[Expr[Any], Expr[Any]]) extends Transformation {
  def apply[T: Staged](e: Expr[T])(using QuoteContext): Expr[T] = {
...
class SafeTransformation[U: Staged](transform: PartialFunction[Expr[U], Expr[U]]) extends Transformation {
  def apply[T: Staged](e: Expr[T])(using QuoteContext): Expr[T] = {
    e match {
