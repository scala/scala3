object Enums/*<-_empty_::Enums.*/:
  ...
  object Suits/*<-_empty_::Enums.Suits.*/:
    extension (suit: Suits) def i/*<-_empty_::Enums.Suits.extension_isRed().*//*<-_empty_::Enums.Suits.extension_isRed().(suit)*//*->_empty_::Enums.Suits#*/sRed: Boolean/*->scala::Boolean#*/ =
    ...
    extension (suit: Suits) def isB/*<-_empty_::Enums.Suits.extension_isBlack().*//*<-_empty_::Enums.Suits.extension_isBlack().(suit)*//*->_empty_::Enums.Suits#*/lack: Boolean/*->scala::Boolean#*/ = suit/*->_empty_::Enums.Suits.extension_isBlack().(suit)*/ match
  ...
  extension [A, B](opt: Opti/*<-_empty_::Enums.extension_unwrap() def *//*<-_empty_::Enums.extension_unwrap().[A]*//*<-_empty_::Enums.extension_unwrap().[B]*//*<-_empty_::Enums.extension_unwrap().(opt)*/on/*->scala::Option#*/[A/*->_empty_::Enums.extension_unwrap().[A]*/]) unwrap(using ev/*<-_empty_::Enums.extension_unwrap().(ev)*/: A/*->_empty_::Enums.extension_unwrap().[A]*/ <:</*->_empty_::Enums.`<:<`#*/ Option/*->scala::Option#*/[B/*->_empty_::Enums.extension_unwrap().[B]*/]): Option/*->scala::Option#*/[B/*->_empty_::Enums.extension_unwrap().[B]*/] = ev/*->_empty_::Enums.extension_unwrap().(ev)*/ match
