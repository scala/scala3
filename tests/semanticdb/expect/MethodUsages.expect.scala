...
class MethodUsages/*<-example::MethodUsages#*/ {
  ...
  m/*->example::MethodUsages#m.*/.m9/*->example::Methods#m9().*/(???/*->scala::Predef.`???`().*/)
  m/*->example::MethodUsages#m.*/.m10/*->example::Methods#m10().*/(???/*->scala::Predef.`???`().*/)
  ...
  m/*->example::MethodUsages#m.*/.m12a/*->example::Methods#m12a().*/(???/*->scala::Predef.`???`().*/)
  m/*->example::MethodUsages#m.*/.m12b/*->example::Methods#m12b().*/(???/*->scala::Predef.`???`().*/)
