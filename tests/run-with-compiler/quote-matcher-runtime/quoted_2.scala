...
object Test {
  ...
  def main(args: Array[String]): Unit = {
    ...
    matches({ val a: Int = 45 }, { val a: Hole[Int] = hole })
    matches({ val a: Int = 45 }, { val a: bindHole[Hole[Int]] = hole })
    matches({ val a: Int = 45 }, { lazy val a: Int = 45 })
    matches({ val a: Int = 45 }, { var a: Int = 45 })
    matches({ val a: Int = 45 }, { var a: bindHole[Hole[Int]] = hole })
    matches({ lazy val a: Int = 45 }, { val a: Int = 45 })
    matches({ lazy val a: Int = 45 }, { lazy val a: Int = 45 })
    matches({ lazy val a: Int = 45 }, { var a: Int = 45 })
    matches({ lazy val a: Int = 45 }, { val a: bindHole[Hole[Int]] = hole })
    matches({ lazy val a: Int = 45 }, { var a: bindHole[Hole[Int]] = hole })
    matches({ var a: Int = 45 }, { val a: Int = 45 })
    matches({ var a: Int = 45 }, { lazy val a: Int = 45 })
    matches({ var a: Int = 45 }, { var a: Int = 45 })
    matches({ var a: Int = 45 }, { val a: bindHole[Hole[Int]] = hole })
    matches({ var a: Int = 45 }, { lazy val a: bindHole[Hole[Int]] = hole })
    ...
    matches({ def a: Int = 45 }, { def a: Hole[Int] = hole[Int] })
    ...
    matches({ def a(x: Int)(y: Int): Int = 45 }, { def a(x: Int): Int = 45 })
    matches({ def a(x: String): Int = 45 }, { def a(x: Hole[String]): Hole[Int] = 45 })
