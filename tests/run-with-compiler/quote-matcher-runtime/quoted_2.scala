...
object Test {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // matches((x: Int) => "abc", (x: bindHole[Int]) => patternHole[String])
    ...
    // matches({ val a: Int = 45 }, { val a: bindHole[Int] = patternHole })
    matches({ val a: Int = 45 }, { lazy val a: Int = 45 })
    matches({ val a: Int = 45 }, { var a: Int = 45 })
    // matches({ val a: Int = 45 }, { var a: bindHole[Int] = patternHole })
    matches({ lazy val a: Int = 45 }, { val a: Int = 45 })
    matches({ lazy val a: Int = 45 }, { lazy val a: Int = 45 })
    matches({ lazy val a: Int = 45 }, { var a: Int = 45 })
    // matches({ lazy val a: Int = 45 }, { val a: bindHole[Int] = patternHole })
    // matches({ lazy val a: Int = 45 }, { var a: bindHole[Int] = patternHole })
    matches({ var a: Int = 45 }, { val a: Int = 45 })
    matches({ var a: Int = 45 }, { lazy val a: Int = 45 })
    matches({ var a: Int = 45 }, { var a: Int = 45 })
    // matches({ var a: Int = 45 }, { val a: bindHole[Int] = patternHole })
    // matches({ var a: Int = 45 }, { lazy val a: bindHole[Int] = patternHole })
    ...
    // matches({ def a: Int = 45 }, { def a: bindHole[Int] = patternHole[Int] })
