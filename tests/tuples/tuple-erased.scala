object Test {
  def main(args: Array[String]): Unit = {
    ...
    assert(t02.asInstanceOf[TupleCons[_, _]] == t02)
    assert(t05.asInstanceOf[TupleCons[_, _]] == t05)
    assert(t21.asInstanceOf[TupleCons[_, _]] == t21)
    assert(t22.asInstanceOf[TupleCons[_, _]] == t22)
    assert(t23.asInstanceOf[TupleCons[_, _]] == t23)
    assert(t24.asInstanceOf[TupleCons[_, _]] == t24)

    assert(t02.isInstanceOf[TupleCons[_, _]])
    assert(t05.isInstanceOf[TupleCons[_, _]])
    assert(t21.isInstanceOf[TupleCons[_, _]])
    assert(t22.isInstanceOf[TupleCons[_, _]])
    assert(t23.isInstanceOf[TupleCons[_, _]])
    assert(t24.isInstanceOf[TupleCons[_, _]])
